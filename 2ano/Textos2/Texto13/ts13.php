...
<p>Então, como ficou a repartição das fontes de energia no Brasil tendo em vista o critério de energias limpas
            ou aquelas não tão limpas assim? Veja ai abaixo:</p>
<div class="w3-margin"><img alt="ts13f02" class="w3-mobile" id="imagem2" src="ts13f02.png"/>
<span class="w3-small w3-margin-left" id="citacao2"> Fonte: BEN (2023, p.14). </span>
</div>
<p>A maior parte são fontes de energia <strong>não renováveis</strong>. É literalmente a queima do combustível,
            isto é, lenha, carvão mineral, petróleo, gás natural, urânio, <span class="w3-yellow" onclick="document.getElementById('lixivia').style.display='block'">lixívia</span>,
            dentre outros.</p>
<div class="w3-modal w3-margin-top" id="lixivia">
<div class="w3-modal-content">
<div class="w3-container w3-padding">
<span class="w3-button w3-red w3-display-topright" onclick="document.getElementById('lixivia').style.display='none'">×</span>
<p>
                        A <strong>Lixívia</strong> ou resíduos de licor negro é outro derivado da madeira que é bastante
...
<p>Veja na imagem os destinos das principais fontes de energia no Brasil:</p>
<div class="w3-margin"><img alt="ts13f03" class="w3-mobile" id="imagem3" src="ts13f03.png"/>
...
<p>Mesmo as fontes de energia renováveis não escapam desses impactos ambientais negativos. A lenha e o carvão
            ...
            energia hidrelétrica também apresenta problemas sazonais, como a menor produção durante épocas de seca. </p>
<p>Agora que sabemos que a energia é importante, seus tipos principais, vamos ver com mais detalhes aquele
...
<p> E a produção nacional de petróleo concentra-se principalmente no Rio de Janeiro, Espírito Santo, Rio Grande
            ...
            interno do país!</p>
<p>E além de ser uma fonte de energia, o petróleo também é importante matéria-prima para vários tipos de
            indústria, como plásticos, borrachas sintéticas, fertilizantes, inseticidas, pesticidas, medicamentos e
            produtos químicos. </p>
<h3>A camada Pré-Sal</h3>
<p>Quais são as principais áreas produtoras de petróleo no Brasil? </p>
<p> Há várias áreas que produzem esse precioso combustível, desde a Bahia até o Rio de Janeiro. </p>
<p> A região de Campos, no Rio de Janeiro, é a principal produtora, mas há outras como a Recôncavo Baiano, a
...
<h4 class="fontePixel"><b>Qual é a principal riqueza mineral encontrada no petróleo?</b></h4>
...
<button class="btn-acao-duvid" onclick="validarRadio(this, 'pergunta1', 'resp1', 'globinho1', 'o carbono é a principal riqueza mineral encontrada no petróleo, permite a fabricação de uma variedade de produtos químicos, como combustíveis, plásticos, tintas etc.', '10')">
                    Confirmar Resposta
                </button>
</div>
...
<p>Mas não pense que é só cavar a terra que o carvão aparece, não é tão fácil assim. Ele pode ser encontrado em
...
<p> Mas, claro, tudo tem um preço, e o carvão não é diferente. Além de ser uma fonte de energia não renovável, o
...
<div class="w3-modal w3-margin-top" id="coqueificavel">
<div class="w3-modal-content">
<div class="w3-container w3-padding">
<span class="w3-button w3-red w3-display-topright" onclick="document.getElementById('coqueificavel').style.display='none'">×</span>
<p>
<strong>Coqueiﬁcável</strong>: que pode ser transformado em coque por processos economicamente
                        viáveis. O coque é um resíduo sólido da destilação do carvão (carbono praticamente puro), mais
                        rico que este em capacidade caloríﬁca e, portanto, mais adequado para produzir calor nos
                        altos-fornos.
...
<p>É interessante ver como um recurso tão antigo ainda é tão importante na nossa vida cotidiana, não é mesmo?
            Vamos continuar a explorar e aprender mais sobre as fontes de energia e sua importância! </p>
<div class="w3-panel w3-leftbar w3-sand w3-margin w3-padding">
<h3>O outro lado da Moeda (ou do Carvão)</h3>
<p>A produção e utilização do carvão como fonte de energia é uma atividade altamente prejudicial ao meio
...
<div class="topico">
<h2>Gás Natural </h2>
<p>Também temos o gás natural, que é uma fonte de energia fóssil formada a partir da decomposição de matéria
            ...
            e calor, além de ser um importante insumo em diversas indústrias. </p>
<div class="w3-panel w3-leftbar w3-pale-yellow w3-margin w3-padding">
<h3><strong>Se Você não sabia, agora já sabe!</strong></h3>
<p>O gasoduto Bolívia-Brasil é uma das maiores infraestruturas de transporte de gás natural da América do
                Sul, conectando a Bolívia, país produtor de gás, ao Brasil, um dos maiores consumidores da commodity na
                região. Foi inaugurado em 1999 e desde então tem sido uma fonte importante de gás para o Brasil.</p>
...
<div class="topico pergunta-bloco w3-container w3-padding-24">
<p class="w3-text-grey w3-small">QUESTÃO PRÁTICA</p>
<h4 class="fontePixel"><b>Quais são as consequências negativas da exploração do carvão mineral para o meio ambiente no Brasil?</b></h4>
<div class="grupo-respostas w3-margin-top">
<div class="item-resposta">
<input class="radio-duvid" id="p3a" name="pergunta3" type="radio" value="correto"/>
<label class="card-opcao" for="p3a">
<span>a) aumento da poluição atmosférica e contaminação do solo.</span>
</label>
</div>
<div class="item-resposta">
<input class="radio-duvid" id="p3b" name="pergunta3" type="radio" value="errado"/>
<label class="card-opcao" for="p3b">
<span>b) diminuição da poluição da água e preservação da biodiversidade.</span>
</label>
</div>
<div class="item-resposta">
<input class="radio-duvid" id="p3c" name="pergunta3" type="radio" value="errado"/>
<label class="card-opcao" for="p3c">
<span>c) aumento da poluição da água e diminuição da biodiversidade.</span>
</label>
</div>
</div>
<div class="w3-margin-top">
<button class="btn-acao-duvid" onclick="validarRadio(this, 'pergunta3', 'resp3', 'globinho3', 'a exploração do carvão mineral pode levar a vários problemas ambientais, incluindo aumento da poluição atmosférica e contaminação do solo.', '10')">
                    Confirmar Resposta
                </button>
</div>
...
<p>Com a produção crescente de petróleo, o Brasil se tornou um dos maiores produtores da América Latina,
            ...
            onde antes havia pouca atividade econômica.</p>
<p>No entanto, o petróleo também tem seus desafios, como a exploração em áreas sensíveis e a possibilidade de
            ...
            produção pode ser afetada por mudanças políticas e econômicas.</p>
<p>Em resumo, o petróleo é um dos principais motores do desenvolvimento capitalista no Brasil, mas é importante
...
<p> Por essas e outras razões, é importante que a exploração do carvão seja feita de maneira responsável e
            sustentável, buscando minimizar seus impactos negativos sobre o meio ambiente e as comunidades locais.</p>
