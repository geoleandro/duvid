...
<div class="topico">
<h2> Introdução </h2>
<p> <span class="primeiraLetra">N</span>o último encontro, estudamos a formação do povo brasileiro a partir de distintos grupos étnicos. </p>
<p>Hoje, vamos tomar conhecimento da geografia agrária, isto é, como o capitalismo criou um perfil de distribuição de terras no Brasil e como a população vive nesses territórios. </p>
<p>
            Veremos a formação e os conflitos existentes na atual estrutura agrária e a questão da reforma agrária no intuito de melhor compreender as desigualdades no campo no tempo presente. </p>
...
<span class="w3-button w3-red w3-display-topright" onclick="document.getElementById('exodo').style.display='none'">×</span>
<p><strong>Êxodo rural</strong>: processo de migração de pessoas da zona rural para a urbana, ou seja, a saída de moradores do campo com destino às grandes cidades.
                        </p>
</div>
</div>
</div>
...
<p> O Estado de Mato Grosso, por exemplo, é o campeão nacional dos latifúndios, pois concentra em seu território 75% de <span class="w3-yellow" onclick="document.getElementById('latifundio').style.display='block'">latifúndios</span>. </p>
<div class="w3-modal w3-margin-top" id="latifundio">
<div class="w3-modal-content">
<div class="w3-container w3-padding">
<span class="w3-button w3-red w3-display-topright" onclick="document.getElementById('latifundio').style.display='none'">×</span>
<p><strong>Latifúndio</strong>: propriedade rural ou excessivamente grande (maior do que 600 módulos rurais) ou mantida inexplorada com fins especulativos. Um módulo rural é aquele que “direta e pessoalmente, é explorado pelo agricultor e sua família, garantindo-lhes a subsistência e o progresso social e econômico, com área máxima fixada para cada região e tipo de exploração”. O valor do módulo varia entre as regiões, partindo de 5 até 110 hectares na Amazônia, por exemplo.
                        </p>
</div>
</div>
</div>
<div class="w3-margin"><img alt="ts04f03" class="w3-mobile" id="imagem3" src="ts04f03.png"/>
<span class="w3-small w3-margin-left" id="citacao3"> Fonte: (Latifúndios 2022).</span>
</div>
<p>
            A maioria dos pequenos proprietários possuem <span class="w3-yellow" onclick="document.getElementById('minifundio').style.display='block'">minifúndios</span>. </p>

<div class="w3-modal w3-margin-top" id="minifundio">
<div class="w3-modal-content">
<div class="w3-container w3-padding">
<span class="w3-button w3-red w3-display-topright" onclick="document.getElementById('minifundio').style.display='none'">×</span>
<p><strong>Minifúndio</strong>: toda propriedade com dimensão inferior ao do módulo rural de sua região; em outras palavras, um imóvel rural de tamanho que, mesmo sendo explorado, é insuficiente para garantir ao agricultor e sua família uma vida decente.
                        </p>
</div>
</div>
</div>
...
<p>
            Com essa expansão da soja e da pecuária, principalmente em <span class="w3-yellow" onclick="document.getElementById('devolutas').style.display='block'">terras devolutas</span>, ocorreu intensa derrubada das matas em direção à Amazônia. E outra prática também surgiu. Parte dessa ocupação é formal, ou seja, uma grande empresa, que pode ser multinacional, consegue o título de propriedade da área, mas a deixa ociosa, à espera de valorização. Em consequência disso, a fronteira agrícola só piorou o problema da estrutura agrária concentrada, já que o tamanho médio dessas propriedades, dessas novas terras são enormes, ou seja, a volta do latifúndio no país.
        </p>
<div class="w3-modal w3-margin-top" id="devolutas">
<div class="w3-modal-content">
<div class="w3-container w3-padding">
<span class="w3-button w3-red w3-display-topright" onclick="document.getElementById('devolutas').style.display='none'">×</span>
<p>
<strong>Terras devolutas</strong>: são terras públicas sem destinação pelo Poder Público e que em nenhum momento integraram o patrimônio de um particular, ainda que estejam irregularmente sob sua posse. O termo "devoluta" relaciona-se ao conceito de terra devolvida.
                 
                </p>
</div>
</div>
</div>
<p> Surge um problema quando há muitos latifúndios, grandes propriedades de terra. O primeiro deles está relacionado a produção de alimentos. As grandes propriedades estão massivamente voltadas para a exportação de gêneros agrícolas como soja, milho, carne bovina etc. Várias pesquisas apontam que mais de 70% dos alimentos que estão à mesa do brasileiro são de origem familiar, isto é, de pequenas propriedades familiares. Sendo assim, a concentração da estrutura fundiária explica a queda na produção de gêneros alimentícios básicos e o crescimento das exportações. (Retomaremos esse tema na aula sobre produção agropecuária brasileira).</p>
<p> <strong>A modernização agrícola</strong>: também tem colaborado para a concentração fundiária, principalmente desde a década de 1970. Nesse caso, o problema é que as fazendas que se modernizam começam a priorizar o aumento da produtividade e o aumento da produção, o que leva seus proprietários a comprarem propriedades de vizinhos. Esse processo é um dos fatores que explica a intensa urbanização ocorrida no país nas décadas de 1970 e 1980.</p>
<button class="btnShow" onclick="MostrarProximo(this); this.style.display='none'">Proximo</button>
<hr/>
</div>
<div class="topico">
...
<h4 class="fontePixel"><b>Sobre a agricultura brasileira, marque a correta:</b></h4>
...
<span>b) A mecanização da agricultura é uma das manifestações da modernização agrícola e trouxe consigo o êxodo rural.</span>
</label>
</div>
<div class="item-resposta">
<input class="radio-duvid" id="p1c" name="pergunta1" type="radio" value="errado"/>
<label class="card-opcao" for="p1c">
<span>c) A agricultura familiar, graças ao amplo financiamento, se dedica intensamente à exportação.</span>
</label>
</div>
</div>
<div class="w3-margin-top">
<button class="btn-acao-duvid" onclick="validarRadio(this, 'pergunta1', 'resp1', 'globinho1', 'boa, o desenvolvimento técnológico é um dado técnico, mas as escolhas são um dado político', '10')">
                    Confirmar Resposta
                </button>
</div>
...
<div class="topico pergunta-bloco w3-container w3-padding-24">
<p class="w3-text-grey w3-small">QUESTÃO PRÁTICA</p>
<h4 class="fontePixel"><b>Sobre a questão agrária no Brasil, marque a resposta <strong>errada</strong>:</b></h4>
<div class="grupo-respostas w3-margin-top">
<div class="item-resposta">
<input class="radio-duvid" id="p2a" name="pergunta2" type="radio" value="correto"/>
<label class="card-opcao" for="p2a">
<span>a) Historicamente, a distribuição de terras no Brasil visava a repartir as terras igualmente entre a Coroa e os colonos.</span>
</label>
</div>
<div class="item-resposta">
<input class="radio-duvid" id="p2b" name="pergunta2" type="radio" value="errado"/>
<label class="card-opcao" for="p2b">
<span>b) A estrutura fundiária apresenta acentuada concentração da propriedade, decorrente das formas de apropriação das terras, desde o período colonial.</span>
</label>
</div>
<div class="item-resposta">
<input class="radio-duvid" id="p2c" name="pergunta2" type="radio" value="errado"/>
<label class="card-opcao" for="p2c">
<span>c) Minifúndio: propriedade agrícola de pequena extensão com produção voltada à subsistência.</span>
</label>
</div>
</div>
<div class="w3-margin-top">
<button class="btn-acao-duvid" onclick="validarRadio(this, 'pergunta2', 'resp2', 'globinho2', 'realmente, a distribuição de terras era utilizada como meio de ocupar áreas desabitadas e facilitar o controle do território.', '10')">
                    Confirmar Resposta
                </button>
</div>
...
<div class="topico">
<h2> O caso da reserva indígena Raposa/Serra do Sol</h2>
...
<h3>Instruções:</h3>
<p>
<strong>Divisão em Grupos:</strong>
<br/>
...
<li>Líder comunitário de uma área de conflito por terra</li>
<li>Representante de uma grande empresa agropecuária</li>
<li>Ativista ambiental</li>
<li>Político local</li>
<li>Representante de uma comunidade indígena</li>
<li>Outros...</li>
</ul>
<p>
<strong>Elaboração do Diálogo:</strong>
<br/>
