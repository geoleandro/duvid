...
<p>Esses dois países da Península Ibérica oficializaram suas negociações em um Tratado chamado de Tordesilhas,
...
<button class="btn-acao-duvid" onclick="validarRadio(this, 'pergunta1', 'resp1', 'globinho1', 'o Feudalismo já estava em decadência como sistema dominante, ganhou seu primeiro globinho nessa lição', '10')">
                    Confirmar Resposta
                </button>
</div>
...
<div class="w3-margin-top">
<button class="btn-acao-duvid" onclick="validarRadio(this, 'pergunta2', 'resp2', 'globinho2', 'essa foi interessante, será que o Brasil é realmente integrado?  Valeu', '10')">
                    Confirmar Resposta
                </button>
</div>
...
<p>Com os crescimento das cidades um dos principais motivos para essa expansão além-mar era a busca por novos
            ...
            vai.</p>
<p>Por isso que a distribuição da população ficou concentrada no litoral, pois lá havia os portos, a navegação
            ...
            Qualquer semelhança com o século XX não é mera coincidência.</p>
<p>Quem comandava tudo isso? Infelizmente não eram os povos originários do Brasil, ou seja, os indígenas. </p>
<div class="w3-card-4 w3-pale-yellow w3-padding">
...
<p>Tratava-se de uma minoria, isto é, uma elite formada a partir de concessões de terras. Eles se tornavam
            ...
            capitanias hereditárias.</p>
<div class="w3-margin-top"><img alt="ts01f05a" class="w3-mobile" id="imagem5a" src="ts01f05a.png"/></div>
<div class="w3-padding"><span class="w3-small" id="citacao5a"> Fonte: Fonte: Cintra (2013, p. 39). Disponível
                em: <https: 80840="" anaismp="" article="" view="" www.revistas.usp.br="">.Acesso em: 27 ago. 2017. </https:></span></div>
<p>O problema era que as capitanias eram extensas demais para gerenciar. A partir disso e seguindo a mesma
            ...
            para quem quisesse produzir com o objetivo de não deixar as terras sem cultivo.</p>
...
<p>As capitanias hereditárias foram realmente os primeiros latifúndios do Brasil, o que demonstra, desde o
            ...
            atuais.</p>
<p>Com o sistema de capitanias, a exploração econômica do Brasil tomou-se mais intensa, além da extração e
            comercialização do pau-brasil, multiplicaram-se os canaviais, já que o açúcar podia ser comercializado na
            Europa com boa margem de lucro. O cultivo desenvolveu-se de acordo com o sistema de <em>plantations</em>
...
<p>Inicialmente, o cultivo da<trong> cana-de-açúcar</trong>o Vicente, baixada santista, porém a atividade não
...
<p>As grandes lavouras ocuparam a área de Mata Atlântica, conhecida le como Zona da Mata. Nesse período,
            ...
            serem vendidas no Brasil, geralmente em condições desumanas no transporte que duravam meses.</p>
<p>Com toda essa exploração da mão de obra foi possível fundar mais cidades, além de São Vicente, a fundação dos
...
<p>Nas proximidades de São Paulo, o rio Tietê e seus afluentes foram vias naturais de acesso ao interior do
            ...
            o apresamento de índios, vendidos como escravos.</p>
<button class="btnShow margemAcima" onclick="MostrarProximo(this); this.style.display='none'">Proximo</button>
<hr/>
<br/>
</div>
...
<span>b) Sistema de &amp;nbspPlantation .</span>
</label>
</div>
<div class="item-resposta">
...
<div class="w3-margin-top">
<button class="btn-acao-duvid" onclick="validarRadio(this, 'pergunta3', 'resp3', 'globinho3', 'pois é, nessa divisão que vemos quem é quem no mundo. Está indo bem', '10')">
                    Confirmar Resposta
                </button>
</div>
...
<p>É claro que outros povos não ficaram só olhando a exploração de Portugal em sua nova terra. Holandeses também
            ...
            São Francisco a criação era bastante intensa que o apelido do rio era “rio dos currais”.</p>
...
<p>Vimos que o principal objetivo de Portugal era garantir a exploração de sua nova colônia. Para isso tinha
            ...
            sesmarias e posse mesmo com o princípio de<em> utis possidetis</em>, ou seja, as terras seriam de quem as
            ocupasse efetivamente sem precisar de títulos anteriores. Além das missões secundários de explorações pelo
            território com a recompensa de obter metais preciosos como ouro.</p>
<p>Foi então que encontraram esse precioso minério na porção central do Brasil que corresponde hoje aos Estados
            ...
            da colônia.</p>
<p>O abastecimento da área de <trong>mineração</trong>ebiam milhares de pessoas em busca de enriquecimento
            ...
            Cuiabá, Cáceres e dezenas de outras.</p>
<p>A mineração tomou-se a mais importante atividade econômica da colônia, o que fez com que a sede de governo
            fosse transferida de Salvador para Rio de Janeiro, mais próximo das áreas mineradoras e com um porto pronto
            para exportar para Portugal.</p>
...
<p>Nelas artistas de origem humilde, reconhecidos por seu talento, impulsionaram o movimento artístico que
            ficara conhecido como Barroco Mineiro. </p>
...
<p>Mas com um território desse tamanho repleto de riquezas não seria fácil controlar todos os movimentos de
            independência. O século XIX seria marcado por diversas revoltas e frentes pioneiras novas.</p>
<div class="w3-card-4 w3-pale-red w3-padding">
<h2>Enquanto isso na Amazônia...</h2>
<p>No Nordeste do século XVII, além do açúcar e da pecuária, destacavam-se como atividade econômicas as
...
<p>Na Amazônia, o foco foi a extração das "drogas do sertão" Eram produtos como urucum, cravo, baunilha,
                ...
                integrantes da América espanhola, capturando milhares de nativos.<span class="w3-small"> (SANTOS,
                    2008).</span></p>
</div>
<button class="btnShow margemAcima" onclick="MostrarProximo(this); this.style.display='none'">Proximo</button>
<hr/>
...
<div class="topico pergunta-bloco w3-container w3-padding-24">
<p class="w3-text-grey w3-small">QUESTÃO PRÁTICA</p>
<h4 class="fontePixel"><b>Leia e marque a opção de acordo com tema: "Desempenhou importante papel na ocupação do interior do Brasil,
...
<div class="w3-margin-top">
<button class="btn-acao-duvid" onclick="validarRadio(this, 'pergunta4', 'resp4', 'globinho4', 'bem tranquila essa questão. Em 2020 o Brasil possuia 218,2 milhões de cabeças de gado', '10')">
                    Confirmar Resposta
                </button>
</div>
...
<p>O século XIX foi o período intenso de redefinição do território brasileiro. Primeiro, o pais consolidou suas
...
<p>A exploração da cafeicultura e ainda com a escravidão fizeram emergir inúmeras cidades paulistas como
...
<p>Com a cafeicultura também as relações de trabalho no Brasil foram alteradas. Enquanto no vale do Paraíba o
            ...
            de 1884 a 1903 entraram no pais mais de um 1 745 mil imigrantes europeus.</p>
<p>A cafeicultura paulista sustentou as finanças do Império e, depois da chamada República Ve (1889-1930). Em
...
<p>Ainda no século XIX, a região Norte conheceu um surto de riqueza associada à exploração de látex na Amazônia.
            ...
            exploradores das drogas de sertão.</p>
...
<p>Durante o período imperial e o republicano, foram incorporados ao território brasileiro aproximadamente 1
            ...
            tratados.</p>
<p>Nesse período, foi decisiva a atuação de José Mana da Silva Paranhos Júnior, barão do Rio Branco Ministro das
...
<li> Palmas: área disputada pelo Brasil e pela Argentina, situada no extremo Oeste dos Estados de Santa
                Catarina e Paraná. A disputa for resolvida por <span class="w3-yellow" onclick="document.getElementById('arbitramento').style.display='block'">arbitramento</span> internacional em 1895.
            </li>
<li>Amapá: área disputada pelo Brasil e pela França (já que a Guiana Francesa até hoje é um Departamento
                ...
                litigio também foi resolvido por arbitragem internacional em 1900. </li>
...
<p><span class="primeiraLetra">R:</span>
            ...
            Geografia através do espaço geográfico como referência. </p>
<p class="borda"> <span class="primeiraLetra">P:</span> <strong>
