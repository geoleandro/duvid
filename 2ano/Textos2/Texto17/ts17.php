...
<head>
    ...
    <meta name="description" content="Conheça os domínios de vegetação do Brasil: Mata dos Cocais, Pantanal, Cerrado, Caatinga e Pampas. Características, biodiversidade e os impactos da ação humana em cada bioma.">
    <meta property="og:title" content="2º ano - Texto 17 - Vegetação II: Domínios">
    <meta property="og:description" content="Conheça os domínios de vegetação do Brasil: Mata dos Cocais, Pantanal, Cerrado, Caatinga e Pampas. Características, biodiversidade e os impactos da ação humana em cada bioma.">
    ...
    <title>2º ano - Texto 17 - Vegetação II: Domínios</title>
...
<div class="topico">
        ...
        <p>A Mata dos Cocais é uma região de transição localizada entre a Floresta Amazônica (a oeste), a Caatinga (a
            ...
            Tocantins, sob o domínio do clima tropical. Justamente por ocupar essa faixa intermediária entre biomas
            tão distintos, a Mata dos Cocais é classificada como um ecótono: recebe influência do clima mais úmido da
        ...
        <p>Predominam as <span class="termo" data-palavra="palmáceas" data-definicao="Família de plantas (palmeiras) com caule único, geralmente sem ramificações, e folhas grandes concentradas no topo. Fornecem óleo, fibra, cera e alimento.">palmáceas</span>, sendo as espécies mais conhecidas:</p>
        <ul>
        ...
        <p><strong>Indústria de Cosméticos:</strong> A região é notável pela exploração de recursos naturais para a
            produção de cosméticos, especialmente aqueles derivados do coco de babaçu. O óleo extraído da amêndoa é
            usado em sabonetes, cremes e produtos de higiene vendidos em todo o Brasil, o que faz da Mata dos Cocais
            uma das poucas formações vegetais do país em que a exploração sustentável de um único fruto sustenta, ao
            mesmo tempo, a economia doméstica das famílias extrativistas e cadeias industriais de maior escala.</p>
        <p><strong>Desmatamento e Degradação Ambiental:</strong> A pressão econômica para a extração de recursos e a
            expansão agrícola tem levado ao desmatamento e à degradação do ecossistema da Mata dos Cocais. Por estar
            situada bem na rota de expansão do agronegócio que avança tanto do Cerrado quanto do Matopiba (região que
            reúne Maranhão, Tocantins, Piauí e Bahia, hoje uma das principais fronteiras da soja no Brasil), a Mata
            dos Cocais acaba funcionando como uma zona de amortecimento sob dupla pressão: perde território tanto
            para pastagens quanto para grandes lavouras mecanizadas, o que reduz progressivamente a área disponível
            para as palmeiras nativas.</p>
        ...
        <p><strong>Quebradeiras de Coco Babaçu:</strong> Um dos aspectos sociais mais importantes da Mata dos Cocais é
            o trabalho das quebradeiras de coco babaçu, mulheres extrativistas que, há gerações, vivem da coleta e da
            quebra manual do fruto do babaçu para extrair a amêndoa, usada na produção de óleo, sabão e carvão. Essa
            atividade sustenta milhares de famílias no Maranhão, no Piauí e no Tocantins, mas enfrenta pressão
...
<div class="topico">
        ...
        <p>O Pantanal é a maior planície alagada do mundo, situado principalmente nos estados do Mato Grosso e Mato
            ...
            de rios, lagoas e áreas alagadiças. Seu funcionamento ecológico é regido pelo chamado pulso de
            inundação: durante o verão, o excesso de água dos rios que descem do planalto se espalha lentamente pela
            planície, alagando-a por meses; no inverno seco, as águas recuam e deixam para trás lagoas temporárias
            (as baías) e pastagens naturais extremamente férteis. É justamente essa alternância entre cheia e seca
            que sustenta a riqueza de vida do Pantanal e explica por que, apesar de estar cercado por Cerrado ao
            norte e leste, ele mantém uma dinâmica hídrica própria e completamente diferente.</p>

        <p><strong>Vegetação Predominante:</strong></p>
        <p>A vegetação do Pantanal é uma combinação de espécies de cerrado, floresta amazônica e <span class="termo" data-palavra="Chaco boliviano" data-definicao="Região de vegetação seca e arbustiva que se estende pela Bolívia, Paraguai e Argentina, contribuindo com espécies vegetais adaptadas à seca para a flora do Pantanal.">chaco boliviano</span>,
        ...
        <p><strong>Pecuária Extensiva:</strong> A criação de gado é a principal atividade econômica, causando alterações
            no solo e na vegetação. Ao contrário do que ocorre em outros biomas, a pecuária pantaneira tradicional é
            considerada relativamente compatível com a conservação: o gado se alimenta das pastagens naturais que
            surgem durante a vazante, sem a necessidade de desmatamento extensivo, o que fez do Pantanal um dos
            biomas brasileiros historicamente menos desmatados. Esse equilíbrio, no entanto, vem sendo pressionado
            pela conversão de áreas naturais em pastagens plantadas e pelo avanço da soja no entorno da planície.</p>
...
<h4 class="fontePixel"><b>Marque a alternativa correta sobre as inundações periódicas do Pantanal:</b></h4>
<div class="grupo-respostas w3-margin-top">
<div class="item-resposta">
<input class="radio-duvid" id="p1a" name="pergunta1" type="radio" value="errado"/>
<label class="card-opcao" for="p1a">
<span>a) As inundações do Pantanal são causadas principalmente pelo alto volume de chuvas, o maior entre todos os biomas brasileiros.</span>
</label>
</div>
<div class="item-resposta">
...
<span>c) O Pantanal não sofre inundações periódicas, apenas secas prolongadas.</span>
</label>
</div>
</div>
...
<div class="topico">
        ...
        <p><strong>Agronegócio:</strong> A expansão da agricultura e pecuária tem levado ao desmatamento extensivo do
            Cerrado. O bioma se tornou, nas últimas décadas, a principal fronteira agrícola do país: seu relevo
            plano, associado a solos que foram corrigidos com calcário e fertilizantes para permitir o cultivo de
            soja, milho e algodão, transformou o interior do Brasil Central em um dos maiores produtores de grãos do
        ...
        <p><strong>O Cerrado como "Berço das Águas":</strong> Além de sua riqueza em espécies, o Cerrado tem um papel
        ...
        <p><strong>Monitoramento por <span class="termo" data-palavra="sensoriamento remoto" data-definicao="Técnica de obter informações sobre a superfície terrestre por meio de satélites e sensores, sem contato físico direto com o local.">Sensoriamento Remoto</span>:</strong> O fogo é, em certa medida, um elemento natural do
...
<div class="topico pergunta-bloco w3-container w3-padding-24">
<p class="w3-text-grey w3-small">QUESTÃO PRÁTICA</p>
<h4 class="fontePixel"><b>De acordo com a aula, marque a alternativa correta sobre o papel hidrológico do Cerrado:</b></h4>
<div class="grupo-respostas w3-margin-top">
<div class="item-resposta">
<input class="radio-duvid" id="p2a" name="pergunta2" type="radio" value="errado"/>
<label class="card-opcao" for="p2a">
<span>a) O Cerrado não tem relação significativa com os recursos hídricos brasileiros.</span>
</label>
</div>
<div class="item-resposta">
<input class="radio-duvid" id="p2b" name="pergunta2" type="radio" value="correto"/>
<label class="card-opcao" for="p2b">
<span>b) O Cerrado é chamado de "berço das águas" porque concentra nascentes que alimentam 8 das 12 grandes regiões hidrográficas do Brasil.</span>
</label>
</div>
<div class="item-resposta">
<input class="radio-duvid" id="p2c" name="pergunta2" type="radio" value="errado"/>
<label class="card-opcao" for="p2c">
<span>c) Toda a água do Cerrado vem exclusivamente de rios que nascem na Floresta Amazônica.</span>
</label>
</div>
</div>
<div class="w3-margin-top">
<button class="btn-acao-duvid" onclick="validarRadio(this, 'pergunta2', 'resp2', 'globinho2', 'O Cerrado é conhecido como \'berço das águas\' porque concentra nascentes e áreas de recarga que alimentam 8 das 12 grandes regiões hidrográficas do Brasil, além de abrigar três grandes aquíferos subterrâneos: Guarani, Bambuí e Urucuia.', '10')">
                    Confirmar Resposta
                </button>
</div>
...
<div class="topico">
        ...
        <p><strong>Localização e Características Gerais:</strong></p>
        <p>A Caatinga é o único bioma exclusivamente brasileiro, cobrindo cerca de 10% do território nacional, predominantemente no Nordeste.</p>

        <p><strong>Vegetação Predominante:</strong></p>
        <p>Caracteriza-se por uma vegetação <span class="termo" data-palavra="xerófila" data-definicao="Vegetação adaptada a ambientes secos, com folhas pequenas ou transformadas em espinhos, cascas grossas e raízes profundas para reduzir a perda de água.">xerófila</span>, adaptada ao clima semiárido, incluindo cactos, arbustos espinhosos e árvores de pequeno porte.
            Espécies como o mandacaru, o xique-xique e a coroa-de-frade armazenam água em seus caules suculentos,
...
<div class="topico">
        ...
        <p><strong>Um mosaico de vegetações:</strong> Se olharmos para os cinco domínios que estudamos nesta aula,
            fica claro que a vegetação brasileira não é uma coisa só: a Mata dos Cocais é uma zona de transição
            dominada por palmeiras; o Pantanal é uma planície moldada pelo ritmo das águas; o Cerrado é uma savana
            que também funciona como reservatório hídrico do país; a Caatinga é um bioma exclusivamente brasileiro,
        ...
        <p><span class="primeiraLetra">R:</span>
            Segundo dados do IBGE e do MapBiomas, o Cerrado já perdeu cerca de metade de sua cobertura vegetal
            nativa. O agronegócio, especialmente o plantio da soja, tem desempenhado um papel significativo na
            transformação dessa região. A expansão das fronteiras agrícolas tem levado à conversão de matas nativas
            em grandes áreas de monocultura, conhecidas como <span class="termo" data-palavra="desertos verdes" data-definicao="Expressão usada para grandes áreas de monocultura (como soja ou eucalipto) que, apesar de verdes, sustentam pouquíssima biodiversidade em comparação com a vegetação nativa que substituíram.">"desertos verdes"</span>, o que resulta na perda de
            biodiversidade e na degradação dos ecossistemas naturais do Cerrado.
        </p>
        ...
        <p><span class="primeiraLetra">R:</span>
            ...
            de escoar, formando as extensas áreas alagadas características do Pantanal.
        </p>

        <p class="w3-border w3-round-large w3-padding"> <span class="primeiraLetra">P:</span><strong>
                Quais são os principais conflitos que surgem no Cerrado e nos Pampas devido às práticas agrícolas e ao
                uso da terra?
            </strong>
        </p>
        <p><span class="primeiraLetra">R:</span>
    ...
    <div class="topico">
        <div class="w3-panel w3-pale-yellow w3-margin">
            ...
            <h3>1. Explique por que a Mata dos Cocais é considerada uma vegetação de transição, e cite os três estados onde ela predomina.</h3>
            <h3>2. Cite as três palmeiras mais características da Mata dos Cocais e uma utilidade econômica de cada uma.</h3>
            <h3>3. Por que o Pantanal é considerado a maior planície alagável do mundo? Explique o papel da topografia nesse processo.</h3>
            <h3>4. O que são as veredas do Cerrado e por que elas são consideradas fundamentais para a biodiversidade do bioma?</h3>
            <h3>5. O que são os "desertos verdes" e qual é a relação desse conceito com a expansão do agronegócio no Cerrado?</h3>
            <h3>6. Por que a Caatinga é chamada de único bioma exclusivamente brasileiro, e quais adaptações sua vegetação xerófila apresenta ao clima semiárido?</h3>
            <h3>7. Explique o processo de desertificação e como as atividades humanas podem intensificá-lo na Caatinga.</h3>
            <h3>8. O que é a arenização e em qual bioma brasileiro ela ocorre com mais destaque?</h3>
            <h3>9. De que forma o sensoriamento remoto e instituições como o INPE e a UFMG contribuem para o monitoramento e combate a incêndios no Cerrado?</h3>
            <h3>10. Compare os principais conflitos pelo uso da terra no Cerrado e nos Pampas, apontando uma semelhança e uma diferença entre eles.</h3>
        </div>
        <button class="btnShow" onclick="MostrarProximo(this); this.style.display='none'">Proximo</button>
        <hr>
    </div>
    ...
    ProcessarResposta(this, {
        ...
        classe: '',
        mensagem: 'o tema Vegetação II: Domínios é fantástico! Continue estudando!',
        pontos: 40
    });
    MostrarProximo(this);
">Próximo</button>
