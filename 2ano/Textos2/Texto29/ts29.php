...
<head>
    ...
    <title>2º ano - Texto 29 - O Espaço das Cidades</title>
...
<body>
    ...
    <main class="w3-content w3-white w3-card-2 w3-padding-large w3-margin-bottom" style="max-width:750px">
        ...
        <div class="topico">
            ...
            <p>Anote no caderno: <strong>Você acha que o lugar onde alguém mora dentro da cidade afeta suas chances de vida? Por quê?</strong> Guarde essa resposta. Ao final desta aula, você vai ver que existe um conjunto de nomes e conceitos precisos para esse fenômeno que talvez você já tenha percebido, mas nunca tenha parado para nomear.</p>
        ...
        <div class="topico">
            ...
            <p>O sociólogo Lúcio Kowarick descreveu esse padrão com o conceito de <span class="termo" data-palavra="Espoliação Urbana" data-definicao="Conceito criado pelo sociólogo Lúcio Kowarick em 1979 para descrever a soma de carências que atinge os trabalhadores urbanos: falta de saneamento, transporte, saúde e educação, somada à necessidade de construir a própria casa (autoconstrução) em loteamentos irregulares distantes, sem nenhum apoio do Estado. Para Kowarick, essas privações não são acidentais: são o preço que os trabalhadores pagam para morar na cidade.">espoliação urbana</span>: a soma de carências (falta de saneamento, transporte, saúde, escola) que atinge quem trabalha na cidade mas não tem dinheiro para morar nela em condições dignas. Entre as décadas de 1970 e 1980, com a industrialização acelerada e o êxodo rural, milhões de famílias construíram suas próprias casas, sozinhas, em loteamentos irregulares nas franjas das cidades, sem rede de esgoto, água encanada ou asfalto. Essa autoconstrução, feita nos fins de semana e à noite depois do trabalho, foi durante décadas a única forma de acesso à moradia para grande parte da população urbana brasileira. Muitos desses loteamentos, décadas depois, ainda esperam a regularização fundiária e a chegada completa de infraestrutura básica, mostrando que a espoliação urbana descrita por Kowarick não é só um capítulo do passado: continua moldando o espaço das cidades brasileiras hoje.</p>
        ...
        <div class="topico pergunta-bloco w3-container w3-padding-24">
            ...
            <div class="grupo-respostas w3-margin-top">
                <div class="item-resposta">
                    ...
                    <label for="p1a" class="card-opcao"><span>É neutro</span></label>
                </div>
                <div class="item-resposta">
                    <input type="radio" name="pergunta1" id="p1b" value="correto" class="radio-duvid">
                    <label for="p1b" class="card-opcao"><span>Aprofunda a segregação</span></label>
                </div>
                <div class="item-resposta">
                    <input type="radio" name="pergunta1" id="p1c" value="errado" class="radio-duvid">
                    <label for="p1c" class="card-opcao"><span>Resolve a segregação</span></label>
                </div>
            </div>

            <div class="w3-margin-top">
                <button class="btn-acao-duvid"
                    onclick="validarRadio(this, 'pergunta1', 'resp1', 'globinho1', 'O Estado investe onde a renda já é maior, aprofundando o abismo entre centro e periferia.', '10')">
                    Confirmar Resposta
                </button>
            </div>
        ...
        <div class="topico">
            ...
            <h3>Enclaves fortificados: quando os ricos se isolam</h3>

            <p>A segregação não acontece só de um lado. Enquanto os mais pobres são empurrados para a periferia pelo preço da terra, uma parcela dos mais ricos escolhe se isolar por vontade própria. A socióloga Teresa Caldeira descreveu esse fenômeno no livro "Cidade de Muros" (2000), cunhando o termo <span class="termo" data-palavra="Enclave Fortificado" data-definicao="Espaço urbano privado, murado e vigiado por sistemas de segurança, como condomínios fechados e shopping centers, voltado para dentro de si mesmo e não para a rua. Conceito criado pela socióloga Teresa Caldeira no livro 'Cidade de Muros' (2000) para descrever como parte da elite urbana passou a buscar isolamento físico como resposta ao medo da violência, alterando o padrão tradicional de segregação centro-periferia.">enclave fortificado</span> para descrever condomínios fechados, shoppings e prédios corporativos cercados de muros, câmeras e seguranças particulares.</p>

            <p>Esses espaços vendem a promessa de um "estilo de vida total": lazer, segurança e convivência apenas com pessoas do mesmo grupo social, sem precisar circular pela cidade "de fora". O discurso que justifica os muros costuma ser o medo da violência, mas o efeito é recriar a segregação em outra direção: em vez de o rico ficar perto do centro e o pobre longe, o rico se muda para um condomínio murado, muitas vezes distante, e passa a evitar o espaço público da cidade. É a mesma lógica de separação social no espaço, só que motivada pela busca de isolamento, e não pela falta de opção.</p>
        ...
        <div class="topico pergunta-bloco w3-container w3-padding-24">
            ...
            <div class="grupo-respostas w3-margin-top">
                <div class="item-resposta">
                    ...
                    <label for="p2a" class="card-opcao"><span>Conurbação</span></label>
                </div>
                <div class="item-resposta">
                    <input type="radio" name="pergunta2" id="p2b" value="errado" class="radio-duvid">
                    <label for="p2b" class="card-opcao"><span>Especulação imobiliária</span></label>
                </div>
                <div class="item-resposta">
                    <input type="radio" name="pergunta2" id="p2c" value="correto" class="radio-duvid">
                    <label for="p2c" class="card-opcao"><span>Gentrificação</span></label>
                </div>
            </div>

            <div class="w3-margin-top">
                <button class="btn-acao-duvid"
                    onclick="validarRadio(this, 'pergunta2', 'resp2', 'globinho2', 'Valorização + expulsão dos moradores originais: o processo completo é a gentrificação.', '10')">
                    Confirmar Resposta
                </button>
            </div>
        ...
        <div class="topico">
            ...
            <p><span class="primeiraLetra">R:</span> O debate é legítimo. A revitalização de áreas degradadas pode trazer melhorias reais: segurança pública, infraestrutura, comércio. O problema não é a melhoria em si, mas quem fica e quem vai embora depois da melhoria. Se a valorização expulsa os moradores originais que moravam lá antes de qualquer investimento, o processo é gentrificação com suas consequências sociais negativas. O ideal seriam políticas de "gentrificação inclusiva": melhorar sem expulsar, por meio de aluguel social, ZEIS e IPTU progressivo para terrenos ociosos. Mas isso exige vontade política que frequentemente não existe, porque expulsar moradores de baixa renda é, do ponto de vista do mercado imobiliário, mais lucrativo do que garantir que eles permaneçam no bairro valorizado.</p>

            <p class="w3-border w3-round-large w3-padding">
                <span class="primeiraLetra">P:</span>
                <strong>O que é o Estatuto da Cidade e por que ele importa?</strong>
            </p>
            <p><span class="primeiraLetra">R:</span> O Estatuto da Cidade (Lei 10.257/2001) é a principal lei federal sobre política urbana brasileira. Ele regulamentou o capítulo de política urbana da Constituição de 1988, que afirma que a propriedade urbana deve cumprir sua função social. O Estatuto criou instrumentos como: IPTU progressivo no tempo (a alíquota do imposto pode dobrar a cada ano, por até 5 anos seguidos, até o limite de 15% do valor do imóvel, para forçar terrenos ociosos a cumprir sua função social), direito de preempção (prefeitura tem preferência na compra de imóveis), outorga onerosa (cobrar pela construção acima do coeficiente básico de aproveitamento do terreno) e usucapião urbana coletiva. É uma lei avançada no papel, mas subaproveitada na prática.</p>
            ...
            <p class="w3-border w3-round-large w3-padding">
                <span class="primeiraLetra">P:</span>
                <strong>Condomínio fechado também é um tipo de segregação?</strong>
            </p>
            <p><span class="primeiraLetra">R:</span> Sim, embora funcione de um jeito diferente da segregação da periferia. Na periferia, a separação acontece porque as famílias não têm dinheiro para morar em áreas com mais infraestrutura. No enclave fortificado (o condomínio murado, o shopping, o prédio corporativo cercado), quem tem dinheiro escolhe se isolar do resto da cidade por vontade própria, geralmente citando medo da violência. O resultado é parecido: grupos sociais diferentes convivendo cada vez menos no mesmo espaço público. A diferença é que, de um lado, a segregação é imposta pela renda, e do outro, é uma escolha de quem pode pagar por muros e segurança.</p>
        ...
        <div class="topico">
            ...
            <div class="w3-panel w3-pale-yellow">
                ...
                <p class="w3-small w3-text-grey">Dica: o IBGE disponibiliza dados de rendimento médio por setor censitário, que permitem visualizar a segregação socioespacial de qualquer cidade brasileira, cruzando renda, cor da pele e escolaridade bairro a bairro.</p>
            </div>
        ...
        <div class="topico">
            ...
            <div class="w3-pale-yellow">
                ...
                <h3>3. O que é gentrificação? Cite um exemplo brasileiro e explique quem perde e quem ganha com o processo. Se um bairro popular recebe investimentos públicos em cultura e lazer, os aluguéis sobem e os moradores antigos precisam sair, como o poder público poderia intervir para evitar essa expulsão?</h3>
                ...
                <h3>9. Qual a relação entre o modelo de mobilidade urbana (que privilegiou o carro particular) e a segregação socioespacial? Quem mais sofre com o trânsito caótico das metrópoles brasileiras?</h3>

                <h3>10. O que são ilhas de calor urbanas e enclaves fortificados? Explique como cada um desses fenômenos se relaciona com a segregação socioespacial, mesmo sendo processos opostos (um atinge quem tem menos renda, o outro é escolhido por quem tem mais).</h3>
            </div>
    ...
    ProcessarResposta(this, {
        ...
        classe: '',
        mensagem: 'o tema O Espaço das Cidades é fantástico! Continue estudando!',
        pontos: 40
    });
    MostrarProximo(this);
">Próximo</button>
