...
// Guard de compatibilidade: duvid-audio.js antigo pode não ter o método tocar.
// Remove assim que duvid-audio.js for atualizado em produção.
...
const gerarAlternativas = (alternativas) => alternativas.map((alt, i) => `
        <div class="item-resposta">
            <input type="radio" name="opcao" id="opt${i}" value="${i}" class="radio-duvid" onchange="if (typeof DuvidAudio !== 'undefined') DuvidAudio.tocar('selecionar')">
...
function verificar() {
    ...
    // catálogo novo — silencioso até o arquivo /audio/fx/enviar existir
    if (typeof DuvidAudio !== 'undefined') DuvidAudio.tocar('enviar');
