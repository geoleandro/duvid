...
<body>
    ...
    <main class="w3-content w3-white w3-card-2 w3-padding-large w3-margin-bottom" style="max-width:750px">
        ...
        <div class="topico">
            ...
            <div class="w3-panel w3-light-grey w3-leftbar w3-border-green w3-round-large w3-padding-16 w3-margin-top">
                ...
                <audio controls style="width:100%; margin-top: 10px;">
                    <source id="audioSource" src="audiott25.mp3" type="audio/mp3">
                </audio>
            </div>
        ...
        <div class="topico">
            ...
            <h2>O que você sabe sobre a África?</h2>

            <p><span class="primeiraLetra">Q</span>uando alguém fala "África", o que vem à sua cabeça? Deserto? Savana com leões e elefantes? Pobreza? Conflitos? Essas imagens existem, mas descrevem apenas fragmentos de um continente gigantesco, com mais de 30 milhões de km² e mais de 1,4 bilhão de pessoas.</p>

            <p>Antes de começar, responda honestamente no caderno:</p>

            <ul>
                <li>Você consegue nomear cinco países africanos sem olhar o mapa? E cinco capitais?</li>
                <li>Você imaginaria que a África tem florestas tropicais tão densas quanto a Amazônia? Ou montanhas com neve permanente no topo?</li>
        ...
        <div class="topico">
            ...
            <p><span class="primeiraLetra">A</span> África é o continente mais rico do mundo em diversidade de minerais, possui o segundo maior rio em volume d'água do planeta, a segunda maior floresta tropical, a maior área de savana e algumas das mais antigas civilizações da história humana. Ao mesmo tempo, é o continente com os maiores índices de insegurança alimentar, desertificação e vulnerabilidade às mudanças climáticas.</p>

            <p>Essa contradição não é obra da natureza: é resultado de séculos de exploração colonial que transformou os recursos naturais africanos em riqueza para outros continentes, deixando populações locais sem acesso ao que é seu. Esta aula começa pela natureza, mas já aponta essa questão que vai nos acompanhar nas próximas aulas.</p>
        ...
        <div class="topico">
            ...
            <ul>
                <li><strong>Cadeia do Atlas:</strong> montanhas jovens ao noroeste (Marrocos, Argélia, Tunísia), formadas pelo encontro das placas africana e euroasiática.</li>
                <li><strong>Deserto do Saara:</strong> maior deserto quente do mundo, com cerca de 9,2 milhões de km², cobre quase todo o norte da África.</li>
                <li><strong>Drakensberg:</strong> cadeia montanhosa no sudeste, no limite entre África do Sul e Lesoto.</li>
                <li><strong>Planalto da Etiópia:</strong> uma das regiões mais elevadas da África (média de 2.000 metros), que influencia diretamente o regime do Rio Nilo.</li>
            </ul>

            </div>

            <div class="w3-margin w3-margin-top">
                <img src="tt25f01.png" alt="Mapa do relevo africano destacando o Rift Valley, o Saara, o Kilimanjaro e as principais formas de relevo do continente"
                    class="w3-mobile"
                    onerror="this.outerHTML='<div style=padding:32px;background:#e8f5e9;border:2px dashed #a5d6a7;border-radius:8px;text-align:center;color:#888>Mapa do relevo africano em breve</div>'">
                <span class="w3-small w3-margin-left">Relevo da África: planaltos, desertos e o sistema do Rift Valley. Fonte: elaboração própria.</span>
            </div>
        ...
        <!-- BLOCO 5: CLIMA E VEGETAÇÃO -->
        <div class="topico">

            <h2>Clima e vegetação</h2>

            <p><span class="primeiraLetra">A</span> África é cortada pelo Equador quase ao meio, o que determina uma distribuição climática em faixas simétricas ao norte e ao sul da linha equatorial. Essa simetria é uma das características mais marcantes do continente e explica a repetição de climas e vegetações nos dois hemisférios.</p>

            <p><strong>Do Equador para os trópicos:</strong></p>
            ...
            <div class="w3-margin w3-margin-top">
                <img src="tt25f02.png" alt="Mapa das zonas climáticas e vegetação da África, mostrando a simetria em relação ao Equador"
                    class="w3-mobile"
                    onerror="this.outerHTML='<div style=padding:32px;background:#fff8e1;border:2px dashed #ffe082;border-radius:8px;text-align:center;color:#888>Mapa climático da África em breve</div>'">
                <span class="w3-small w3-margin-left">Zonas climáticas e vegetação da África. Fonte: elaboração própria com dados da FAO, 2022.</span>
            </div>
        ...
        <div class="topico pergunta-bloco w3-container w3-padding-24">
            ...
            <h4 class="fontePixel"><b>O Rift Valley, sistema de fossas tectônicas do leste africano, é chamado de "berço da humanidade" porque:</b></h4>

            <div class="grupo-respostas w3-margin-top">
                <div class="item-resposta">
                    <input type="radio" name="pergunta1" id="p1a" value="errado" class="radio-duvid">
                    <label for="p1a" class="card-opcao"><span>Primeiro humano surgiu</span></label>
                </div>
                <div class="item-resposta">
                    <input type="radio" name="pergunta1" id="p1b" value="correto" class="radio-duvid">
                    <label for="p1b" class="card-opcao"><span>Fósseis mais antigos</span></label>
                </div>
                <div class="item-resposta">
                    <input type="radio" name="pergunta1" id="p1c" value="errado" class="radio-duvid">
                    <label for="p1c" class="card-opcao"><span>Maior população humana</span></label>
                </div>
            </div>
        ...
        <div class="topico">
            ...
            <div class="w3-margin w3-margin-top">
                <img src="tt25f03.png" alt="Mapa hidrográfico da África mostrando os principais rios (Nilo, Congo, Niger, Zambeze) e os grandes lagos do Rift Valley"
                    class="w3-mobile"
                    onerror="this.outerHTML='<div style=padding:32px;background:#e3f2fd;border:2px dashed #90caf9;border-radius:8px;text-align:center;color:#888>Mapa hidrográfico da África em breve</div>'">
                <span class="w3-small w3-margin-left">Principais rios e lagos da África. Fonte: elaboração própria com dados da FAO Aquastat, 2023.</span>
            </div>
        ...
        <!-- BLOCO 8: PROBLEMAS AMBIENTAIS -->
        <div class="topico">

            <h2>Principais problemas ambientais</h2>

            <p><span class="primeiraLetra">A</span> África é um dos continentes mais vulneráveis às mudanças climáticas, apesar de ser responsável por menos de 4% das emissões globais de gases de efeito estufa. Essa injustiça ambiental, quem polui menos sofre mais, resume bem a situação africana diante dos problemas ambientais contemporâneos.</p>
        ...
        <div class="topico pergunta-bloco w3-container w3-padding-24">
            ...
            <h4 class="fontePixel"><b>A África é responsável por menos de 4% das emissões globais de gases de efeito estufa, mas é o continente mais vulnerável às mudanças climáticas. Esse fenômeno é chamado de:</b></h4>

            <div class="grupo-respostas w3-margin-top">
                <div class="item-resposta">
                    <input type="radio" name="pergunta2" id="p2a" value="errado" class="radio-duvid">
                    <label for="p2a" class="card-opcao"><span>Paradoxo climático africano</span></label>
                </div>
                <div class="item-resposta">
                    <input type="radio" name="pergunta2" id="p2b" value="correto" class="radio-duvid">
                    <label for="p2b" class="card-opcao"><span>Injustiça ambiental</span></label>
                </div>
                <div class="item-resposta">
                    <input type="radio" name="pergunta2" id="p2c" value="errado" class="radio-duvid">
                    <label for="p2c" class="card-opcao"><span>Compensação climática natural</span></label>
                </div>
            </div>

            <div class="w3-margin-top">
                <button class="btn-acao-duvid"
                    onclick="validarRadio(this, 'pergunta2', 'resp2', 'globinho2', 'Injustiça ambiental: quem menos emite sofre mais. A África emite pouco CO2 mas enfrenta as piores secas e desertificação causadas pelos países ricos.', '10')">
                    Confirmar Resposta
                </button>
            </div>
        ...
        <div class="topico">
            ...
            <div class="duvid-bloco-apoio w3-margin-top">
                ...
                <blockquote>
                    <p>"A África é rica em recursos naturais, mas pobre em retornos para sua população. Isso não é acidente: é o resultado de séculos de exploração e de governança que serviu a interesses externos mais do que às necessidades dos africanos. Enquanto o continente exporta madeira, minérios e petróleo em estado bruto, os países que os processam e vendem ficam com a maior parte do valor."</p>
                </blockquote>
            ...
            <div class="w3-panel w3-leftbar w3-sand w3-padding w3-margin-top w3-round-large">
                ...
                <p><strong>1.</strong> Maathai diz que a riqueza africana serve a "interesses externos". Relacione essa afirmação com a situação ambiental do continente: como a exploração dos recursos naturais africanos (madeira, minérios, petróleo) contribui para os problemas ambientais estudados nesta aula?</p>

                <p><strong>2.</strong> A autora é queniana e ganhou o Nobel da Paz em 2004 pelo seu trabalho de reflorestamento e direitos das mulheres no Quênia. Por que você acha que uma líder ambiental africana conecta o problema ambiental ao problema econômico e político? O que ela está dizendo que os dois têm em comum?</p>
        ...
        <div class="topico">
            ...
            <ul>
                <li>Rift Valley e relevo planaltico africano</li>
                <li>Simetria climática em relação ao Equador</li>
                <li>Savana africana, Sahel e Bacia do Congo</li>
                <li>Nilo, Congo, Niger e Zambeze</li>
                <li>Desertificação, injustiça ambiental e mudanças climáticas</li>
            </ul>
        ...
        <div class="topico">
            ...
            <p class="w3-border w3-round-large w3-padding">
                <strong>Por que o relevo africano é tão diferente do relevo sul-americano?</strong>
            </p>
            <p>A América do Sul tem os Andes, uma cadeia de montanhas jovens e elevadas formada pelo encontro de placas tectônicas. A África, em contraste, é formada principalmente por planaltos antigos, originados em escudos cristalinos estáveis há centenas de milhões de anos. O Rift Valley é a exceção: uma zona ativa de separação de placas que criou lagos, vulcões e vales profundos no leste do continente.</p>

            <p class="w3-border w3-round-large w3-padding">
                <strong>Por que a África sofre tanto com as mudanças climáticas se polui tão pouco?</strong>
            </p>
            <p>A vulnerabilidade da África às mudanças climáticas vem de sua geografia (muitas regiões já semiáridas), de sua estrutura econômica (agricultores que dependem da chuva) e da falta de infraestrutura para se adaptar. Países ricos, que emitiram a maior parte dos gases de efeito estufa ao longo da história industrial, têm recursos para se adaptar (diques, irrigação, seguros). A África não tem essa margem. Esse desequilíbrio é chamado de injustiça climática.</p>

            <p class="w3-border w3-round-large w3-padding">
                <strong>O que é a "Grande Muralha Verde"?</strong>
            </p>
            <p>É um projeto de reflorestamento de 8.000 km de extensão, da costa atlântica (Senegal) ao Mar Vermelho (Djibuti), que envolve 11 países do Sahel. O objetivo é criar uma barreira de vegetação que contenha o avanço do Saara para o sul. Além de combater a desertificação, o projeto cria empregos, recupera solos e sequestra carbono da atmosfera. É considerado uma das maiores iniciativas ambientais da história.</p>
        ...
        <div class="topico">
            ...
            <p><span class="primeiraLetra">N</span>o início desta aula, você foi questionado sobre o que imagina quando pensa em "África" e quem produz essas imagens. Agora, com o conhecimento geográfico desta aula, é hora de desafiar as imagens que você recebeu.</p>

            <div class="w3-panel w3-light-grey w3-leftbar w3-border-green w3-round-large w3-padding">

                <p><strong>Opção A:</strong> Você é editor de uma enciclopédia escolar. Escreva um verbete de 15 a 20 linhas sobre "África: diversidade natural" que quebre com o estereótipo do continente árido e pobre. Use pelo menos quatro conceitos do glossário desta aula e cite dados reais de relevo, clima, hidrografia ou biodiversidade.</p>

                <p><strong>Opção B:</strong> Escolha um dos problemas ambientais estudados (desertificação no Sahel, desmatamento do Congo, conflitos pelo Nilo ou derretimento do Kilimanjaro) e escreva uma carta de uma pessoa africana que vive esse problema para uma liderança de um país rico que emite muito carbono. Na carta, explique o problema, suas causas e o que você exige como resposta.</p>
        ...
        <div class="topico">
            ...
            <h3>1. Explique a diferença entre o relevo africano e o sul-americano. Por que a África tem mais planaltos antigos do que montanhas jovens?</h3>

            <h3>2. O que é o Rift Valley? Explique como ele foi formado e cite três elementos geográficos que ele originou.</h3>

            <h3>3. Descreva a distribuição climática da África em relação ao Equador. Por que os climas se repetem de forma simétrica ao norte e ao sul da linha equatorial?</h3>

            <h3>4. Qual é a importância do Rio Nilo para o Egito e para o nordeste africano? Como a construção da Barragem do Renascimento pela Etiópia criou um conflito geopolítico?</h3>

            <h3>5. Compare a floresta do Congo com a floresta Amazônica em termos de extensão, volume d'água e importância climática global.</h3>
        ...
        <!-- BLOCO 14: TRANSIÇÃO PARA AS QUESTÕES FINAIS -->
        <div class="topico">
