...
<head>
    ...
    <meta name="description" content="África III: apartheid, guerras civis, genocídio de Ruanda, crise de refugiados e terrorismo no continente africano">
    <meta property="og:title" content="Texto 27 - África III: Conflitos">
    <meta property="og:description" content="Por que tantos conflitos na África? Apartheid, Ruanda, Boko Haram e a maior crise de refugiados do mundo">
...
<body>
    ...
    <main class="w3-content w3-white w3-card-2 w3-padding-large w3-margin-bottom" style="max-width:750px">
        ...
        <div class="topico">
            ...
            <div class="w3-panel w3-light-grey w3-leftbar w3-border-green w3-round-large w3-padding-16 w3-margin-top">
                ...
                <audio controls style="width:100%; margin-top: 10px;">
                    <source id="audioSource" src="audiott27.mp3" type="audio/mp3">
                </audio>
            </div>
        ...
        <div class="topico">
            ...
            <h2>Uma pergunta sobre violência e responsabilidade</h2>

            <p><span class="primeiraLetra">E</span>m 1994, em cem dias, cerca de 800 mil pessoas foram mortas em Ruanda, na África. Enquanto isso acontecia, a ONU e as potências ocidentais que tinham tropas na região decidiram não intervir. Os soldados foram retirados. O mundo assistiu.</p>

            <p>Antes de começar, reflita:</p>

            <ul>
                <li>Você acha que conflitos étnicos, como o de Ruanda, surgem espontaneamente do "ódio entre povos" ou têm causas históricas que podem ser identificadas e explicadas?</li>
                <li>O apartheid na África do Sul foi um regime de segregação racial que durou de 1948 a 1994. O Brasil também teve escravidão e discriminação racial. Você enxerga alguma semelhança entre esses processos?</li>
                <li>Quando você vê notícias de refugiados africanos tentando atravessar o Mar Mediterrâneo, o que você sente? Você acha que o Brasil tem alguma responsabilidade em relação a essa crise?</li>
            </ul>

            <p>Essas perguntas não têm resposta fácil. Mas esta aula vai te dar ferramentas para respondê-las com mais profundidade do que a maioria das pessoas consegue.</p>
        ...
        <div class="topico">
            ...
            <p><span class="primeiraLetra">P</span>or que a África concentra tantos conflitos armados? A resposta mais fácil, e mais equivocada, é dizer que é "cultural" ou que africanos "são assim". A resposta geográfica e histórica é outra: as fronteiras coloniais artificiais forçaram povos rivais a conviver no mesmo Estado, o controle de recursos naturais atrai disputas violentas, e o abandono das populações mais pobres pelos seus próprios governos cria as condições para extremismos religiosos e étnicos florescerem.</p>

            <p>Entender os conflitos africanos é entender como o colonialismo deixou bombas-relógio espalhadas pelo continente, bombas que seguem explodindo décadas após a independência.</p>
        ...
        <div class="topico">
            ...
            <p>Na prática, o apartheid significava:</p>
            <ul>
                <li>Negros, que eram mais de 70% da população, não tinham direito de votar.</li>
                <li>Negros eram expulsos das cidades e confinados em territórios segregados chamados <em>bantustões</em> ou <em>homelands</em>, áreas geralmente áridas e sem infraestrutura.</li>
                <li>Escolas, hospitais, praias, transportes e até bancos separados por raça, com qualidade muito inferior para os negros.</li>
                <li>O Grupo de Áreas reservava as melhores terras e bairros para os brancos.</li>
            </ul>
            ...
            <div class="w3-margin w3-margin-top">
                <img src="tt27f01.png" alt="Foto de placa de 'somente para brancos' do apartheid sul-africano e imagem da libertação de Nelson Mandela em 1990"
                    class="w3-mobile"
                    onerror="this.outerHTML='<div style=padding:32px;background:#e8f5e9;border:2px dashed #a5d6a7;border-radius:8px;text-align:center;color:#888>Imagem do apartheid e de Mandela em breve</div>'">
                <span class="w3-small w3-margin-left">O apartheid na África do Sul (1948-1994): segregação legal e resistência. Fonte: arquivo histórico.</span>
            </div>
        ...
        <!-- BLOCO 5: GUERRAS CIVIS E GENOCÍDIO -->
        <div class="topico">

            <h2>Guerras civis e genocídios</h2>

            <p><span class="primeiraLetra">D</span>epois das independências, muitos países africanos mergulharam em guerras civis. As causas são múltiplas e se entrelaçam: fronteiras coloniais que misturaram etnias rivais, disputa pelo controle de recursos naturais (petróleo, diamante, coltan), intervenção de potências externas durante a Guerra Fria apoiando diferentes facções, e governos autoritários sem legitimidade popular.</p>

            <h3>Genocídio de Ruanda (1994)</h3>

            <p>O caso mais extremo foi o <span class="termo" data-palavra="Genocídio de Ruanda" data-definicao="Massacre sistemático de tutsis e hutus moderados pelo governo hutu e milícias extremistas em Ruanda entre abril e julho de 1994. Em aproximadamente 100 dias, cerca de 800 mil a 1 milhão de pessoas foram mortas, principalmente com facões e armas simples. O genocídio foi precedido por anos de propaganda de ódio pela rádio governamental. A ONU e as potências ocidentais foram amplamente criticadas por não intervirem mesmo tendo tropas na região. O Tribunal Penal Internacional para Ruanda foi criado para julgar os responsáveis.">genocídio de Ruanda</span>, em 1994. Em cerca de 100 dias, entre 800 mil e 1 milhão de pessoas, principalmente da etnia tutsi, foram mortas por milícias hutus extremistas, muitas vezes com facões e enxadas. A violência foi precedida por meses de propaganda de ódio transmitida pela rádio governamental, que chamava os tutsis de "baratas" a serem exterminadas.</p>

            <p>A divisão entre hutus e tutsis foi <strong>aprofundada pelo colonialismo belga</strong>, que emitiu carteiras de identidade com a "raça" de cada pessoa e privilegiou os tutsis como intermediários da administração colonial. Quando a Bélgica deixou Ruanda, as tensões acumuladas explodiram.</p>
        ...
        <div class="topico pergunta-bloco w3-container w3-padding-24">
            ...
            <h4 class="fontePixel"><b>O genocídio de Ruanda em 1994 foi facilitado por fatores históricos anteriores. Qual deles está diretamente relacionado ao colonialismo belga?</b></h4>

            <div class="grupo-respostas w3-margin-top">
                <div class="item-resposta">
                    <input type="radio" name="pergunta1" id="p1a" value="errado" class="radio-duvid">
                    <label for="p1a" class="card-opcao"><span>Escassez de alimentos</span></label>
                </div>
                <div class="item-resposta">
                    <input type="radio" name="pergunta1" id="p1b" value="correto" class="radio-duvid">
                    <label for="p1b" class="card-opcao"><span>Divisão étnica institucionalizada</span></label>
                </div>
                <div class="item-resposta">
                    <input type="radio" name="pergunta1" id="p1c" value="errado" class="radio-duvid">
                    <label for="p1c" class="card-opcao"><span>Disputa por petróleo</span></label>
                </div>
            </div>

            <div class="w3-margin-top">
                <button class="btn-acao-duvid"
                    onclick="validarRadio(this, 'pergunta1', 'resp1', 'globinho1', 'A Bélgica dividiu hutus e tutsis oficialmente e privilegiou os tutsis. Essa divisão colonial criou ressentimento explorado por líderes radicais décadas depois.', '10')">
                    Confirmar Resposta
                </button>
            </div>
        ...
        <div class="topico">
            ...
            <div class="w3-margin w3-margin-top">
                <img src="tt27f02.png" alt="Mapa dos principais conflitos armados, grupos terroristas e campos de refugiados na África contemporânea"
                    class="w3-mobile"
                    onerror="this.outerHTML='<div style=padding:32px;background:#e3f2fd;border:2px dashed #90caf9;border-radius:8px;text-align:center;color:#888>Mapa dos conflitos africanos contemporâneos em breve</div>'">
                <span class="w3-small w3-margin-left">Conflitos, grupos armados e refugiados na África. Fonte: ACNUR e ACLED, 2023.</span>
            </div>
        ...
        <!-- BLOCO 8: QUESTÃO PRÁTICA 2 -->
        <div class="topico pergunta-bloco w3-container w3-padding-24">
            <p class="w3-text-grey w3-small">QUESTÃO PRÁTICA</p>

            <h4 class="fontePixel"><b>O surgimento do Boko Haram no nordeste da Nigéria está relacionado principalmente a qual fator estrutural?</b></h4>

            <div class="grupo-respostas w3-margin-top">
                <div class="item-resposta">
                    <input type="radio" name="pergunta2" id="p2a" value="errado" class="radio-duvid">
                    <label for="p2a" class="card-opcao"><span>Influência iraniana direta</span></label>
                </div>
                <div class="item-resposta">
                    <input type="radio" name="pergunta2" id="p2b" value="errado" class="radio-duvid">
                    <label for="p2b" class="card-opcao"><span>Tradição guerreira local</span></label>
                </div>
                <div class="item-resposta">
                    <input type="radio" name="pergunta2" id="p2c" value="correto" class="radio-duvid">
                    <label for="p2c" class="card-opcao"><span>Pobreza e ausência do Estado</span></label>
                </div>
            </div>

            <div class="w3-margin-top">
                <button class="btn-acao-duvid"
                    onclick="validarRadio(this, 'pergunta2', 'resp2', 'globinho2', 'O Boko Haram cresce onde o Estado abandona: sem escola, saúde ou emprego, oferece identidade e sustento a jovens sem perspectiva.', '10')">
                    Confirmar Resposta
                </button>
            </div>
        ...
        <div class="topico">
            ...
            <div class="duvid-bloco-apoio w3-margin-top">
                ...
                <blockquote>
                    <p>"Não havia nenhuma ambiguidade étnica inata entre hutus e tutsis. Antes da colonização, as identidades eram fluidas, intercambiáveis e ligadas a status econômico. Foi a colonização belga que tornou a identidade étnica rígida, hereditária e juridicamente fixada em carteiras de identidade. O genocídio de 1994 não foi produto de um ódio ancestral: foi o produto de uma engenharia colonial de divisão e de décadas de propaganda política que explorou essa divisão."</p>
                </blockquote>
            ...
            <div class="w3-panel w3-leftbar w3-sand w3-padding w3-margin-top w3-round-large">
                ...
                <p><strong>1.</strong> Mamdani diz que o genocídio de Ruanda não foi resultado de "ódio ancestral". Por que essa explicação (de que africanos simplesmente se odeiam por razões étnicas) é problemática? O que ela esconde e o que ela revela sobre quem produz esse tipo de narrativa?</p>

                <p><strong>2.</strong> Se a identidade étnica entre hutus e tutsis foi "fabricada" pelo colonialismo belga, isso significa que as pessoas que morreram no genocídio morreram por uma distinção inventada. Como você processa essa informação? O que ela implica para a responsabilidade histórica dos países colonizadores?</p>
        ...
        <div class="topico">
            ...
            <ul>
                <li>Apartheid e bantustões</li>
                <li>Genocídio de Ruanda e identidade étnica colonial</li>
                <li>Guerras civis e disputa por recursos</li>
                <li>Refugiados e rota do Mediterrâneo</li>
                <li>Boko Haram, Al-Shabaab e estado falido</li>
            </ul>
        ...
        <div class="topico">
            ...
            <p class="w3-border w3-round-large w3-padding">
                <strong>O que eram os bantustões no apartheid sul-africano?</strong>
            </p>
            <p>Bantustões (ou homelands) eram territórios segregados para onde a população negra era expulsa sob o apartheid. Eram áreas geralmente áridas, superpopulosas e sem infraestrutura, onde os negros eram confinados enquanto as melhores terras ficavam para os brancos. A lógica era tornar os negros "estrangeiros" em sua própria terra, com "cidadania" apenas no bantustão, não na África do Sul oficial.</p>

            <p class="w3-border w3-round-large w3-padding">
                <strong>Por que a ONU não impediu o genocídio de Ruanda?</strong>
            </p>
            <p>A ONU tinha tropas em Ruanda quando o genocídio começou. O general Roméo Dallaire pediu autorização para intervir, mas o Conselho de Segurança negou. Os Estados Unidos, ainda traumatizados pelo desastre da Somália (1993), não queriam se envolver. A França tinha relações próximas com o governo hutu. O resultado foi a retirada das tropas da ONU enquanto o massacre acontecia. O episódio é considerado um dos maiores fracassos da comunidade internacional no século XX.</p>

            <p class="w3-border w3-round-large w3-padding">
                <strong>Por que refugiados africanos arriscam a vida no Mediterrâneo?</strong>
            </p>
            <p>A travessia do Mediterrâneo é extremamente perigosa, mas para muitos refugiados o perigo de ficar é ainda maior. Fogem de guerras civis, perseguição étnica e religiosa, colapso de estados e fome. A rota pelo Mediterrâneo existe porque a Europa fechou rotas legais de imigração. Quando não há caminho legal, pessoas desesperadas pagam traficantes por embarcações precárias. O problema não é que as pessoas "querem" arriscar a vida no mar: é que não têm outra opção.</p>
        ...
        <div class="topico">
            ...
            <p><span class="primeiraLetra">N</span>o início desta aula, você foi convidado a refletir sobre Ruanda, sobre o apartheid e sobre refugiados no Mediterrâneo. Agora, com as ferramentas que você tem, é hora de ir além do choque e construir uma análise.</p>

            <div class="w3-panel w3-light-grey w3-leftbar w3-border-green w3-round-large w3-padding">

                <p><strong>Opção A:</strong> Escolha um dos conflitos estudados (apartheid, genocídio de Ruanda, guerra civil angolana ou Boko Haram) e escreva um texto de 15 a 20 linhas explicando as causas históricas e estruturais daquele conflito. Mostre como o colonialismo, a disputa por recursos ou o abandono do Estado contribuíram para que ele acontecesse.</p>

                <p><strong>Opção B:</strong> Imagine que você é um jornalista cobrindo a chegada de refugiados africanos à costa europeia. Escreva uma reportagem de 15 a 20 linhas que vá além da cena do naufrágio e explique ao leitor europeu por que essas pessoas saíram de seus países e qual é a responsabilidade histórica da Europa nessa crise.</p>
        ...
        <div class="topico">
            ...
            <h3>1. O que foi o apartheid? Descreva pelo menos três leis ou práticas do sistema de segregação racial na África do Sul.</h3>

            <h3>2. Explique o papel de Nelson Mandela na luta contra o apartheid. Por que ele passou 27 anos preso? O que sua libertação em 1990 representou?</h3>

            <h3>3. Como o colonialismo belga contribuiu para o genocídio de Ruanda em 1994? Explique o papel das carteiras de identidade étnica nesse processo.</h3>

            <h3>4. Por que a comunidade internacional não impediu o genocídio de Ruanda, mesmo tendo tropas da ONU no país?</h3>

            <h3>5. Cite três guerras civis africanas que estudamos, indique suas causas principais e os recursos naturais envolvidos em cada uma.</h3>
