    ...
    <div class="w3-content" style="max-width:1100px; padding: 0 24px;">
        ...
        <div class="w3-row-padding footer-grid" style="margin-bottom: 32px;">
            ...
            <div class="w3-quarter w3-margin-bottom">
                ...
                <a href="/paginas/filmes-geografia.php"         style="display:block; color:rgba(255,255,255,.7); font-size:13px; text-decoration:none; margin-bottom:8px; transition:color .15s;" onmouseover="this.style.color='#fff'" onmouseout="this.style.color='rgba(255,255,255,.7)'">Filmes de Geografia</a>
                <a href="/paginas/livros-sugeridos.php"        style="display:block; color:rgba(255,255,255,.7); font-size:13px; text-decoration:none; transition:color .15s;"                   onmouseover="this.style.color='#fff'" onmouseout="this.style.color='rgba(255,255,255,.7)'">Sugestões de Livros</a>
            </div>
