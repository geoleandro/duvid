    ...
    <main class="w3-content w3-white w3-card-2 w3-padding-large w3-margin-bottom" style="max-width:750px">
        ...
        <div class="topico">
            ...
            <div class="w3-light-blue w3-padding">
                ...
                <p>Você também viu que solos argilosos, arenosos e orgânicos têm vantagens e limites diferentes, e que processos como laterização, lixiviação, salinização e desertificação podem degradar essa camada tão fina e tão lenta de se formar, o que torna práticas como rotação de culturas, plantio direto, reflorestamento e terraceamento essenciais para a segurança alimentar.</p>

                <p><strong>Resumo dos conceitos:</strong> solo e húmus; pedogênese e horizontes do solo; textura do solo; solo argiloso, arenoso e orgânico; laterização, lixiviação, salinização e desertificação; terraceamento.</p>
