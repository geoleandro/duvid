...
<script defer="" src="/estilos/jstextos.js"></script>
<title></title>
<style>
        .topico {
            display: block;
...
<h4 class="fontePixel"><b>A padronização através de fusos horários pelo mundo contribuiu para:</b></h4>
...
<button class="btn-acao-duvid" onclick="validarRadio(this, 'pergunta1', 'resp1', 'globinho1', 'opa, essa foi bem fácil, ganhou seu primeiro globinho', '10')">
                    Confirmar Resposta
                </button>
</div>
...
<div class="area"><img alt="tp3Foto1" class="w3-mobile" id="imagem1" src="tp3Foto1.jpg" style="display:none"/>
</div>
...
<p>A rotação é um movimento realizado no sentido Oeste-Leste, <span onclick="Aparecer('imagem2','citacao2')"><mark>clique para ver a imagem</mark></span>. Temos a impressão
			...
			contrária.</p>
<div class="area"><img alt="tp3Foto2" class="w3-mobile" id="imagem2" src="tp3Foto2.jpg" style="display:none"/>
</div>
...
<p> Desse modo, o Sol aparece no horizonte por volta das 6 da manhã, ele está na posição
			...
			rotação da Terra que provoca tal “ilusão”. <span onclick="Aparecer('imagem3','citacao3')"><mark>Veja
					aqui</mark></span>.</p>
<div class="area"><img alt="sol" height="350" id="imagem3" src="sol.gif" style="display:none" width="330"/></div>
...
<div class="area"><img alt="tp3Foto3" class="w3-mobile" id="imagem4" src="tp3Foto3.jpg" style="display:none"/>
</div>
...
<div class="area"><img alt="grauGif" height="400" id="imagem5" src="graus.gif" style="display:none" width="330"/>
</div>
...
<div class="w3-margin"><input class="input" id="q1a" name="q1a" type="text" value=""/></div>
<p id="resp1a"></p>
<br/><br/>
<input class="btnShow" id="buttonConferirQ1" onclick=" PerAberta(1,'resp1a','buttonConferirQ1','globinho10')" type="button" value="Conferir"/>
</form>
<div class="area">
<p><img alt="globinho10" height="64" id="globinho10" src="globinhoPe.png" style="display:none" width="64"/>
</p>
</div>
...
<p><span class="mark2"> <strong>Fuso horário </strong></span> - São linhas (meridianos)
		...
		<p>
<div class="area"><img alt="tp3Foto4" class="w3-mobile" id="imagem6" src="tp3Foto4.jpg" style="display:none"/>
</div>
...
<div class="area"><img alt="tp3Foto5" class="w3-mobile" id="imagem7" src="tp3Foto5.jpg" style="display:none"/>
</div>
...
<div class="topico pergunta-bloco w3-container w3-padding-24">
<p class="w3-text-grey w3-small">QUESTÃO PRÁTICA</p>
<h4 class="fontePixel"><b>Pergunta</b></h4>
<div class="grupo-respostas w3-margin-top">
<div class="item-resposta">
...
<div class="w3-margin-top">
<button class="btn-acao-duvid" onclick="validarRadio(this, 'pergunta2', 'resp2', 'globinho2', 'Legal, essa foi bem fácil, ganhou mais um globinho. Está indo muito bem!', '10')">
                    Confirmar Resposta
                </button>
</div>
...
<div class="w3-margin"><input class="input" id="f1b" name="f1b" onfocus="this.value=''" type="text" value="Roma"/></div>
<p id="resp1b"></p>
<p>Digite o fuso horário. Ex: 3 ou -3 ?</p>
<div class="w3-margin"><input class="input" id="f1c" name="f1c" onfocus="this.value=''" type="text" value="1"/></div>
</form>
<p id="resp1c"></p>
...
<div class="w3-margin"><input class="input" id="q1d" name="q1d" type="text" value=""/></div>
</form>
<p id="resp1d"></p>
<input class="btnShow" id="buttonConferirQ1d" onclick=" PerAberta(2,'resp1d','buttonConferirQ1d','globinho11')" type="button" value="Conferir"/>
<div class="area">
<p><img alt="globinho11" height="64" id="globinho11" src="globinhoPe.png" style="display:none" width="64"/>
</p>
</div>
...
<div class="w3-margin"><input class="input" id="q1e" name="q1e" type="text" value=""/></div>
</form>
<p id="resp1e"></p>
<input class="btnShow" id="btnConferirQ1e" onclick=" PerguntasAbertas(3,'resp1d','btnConferirQ1e','globinho111')" type="button" value="Conferir"/>
<div class="area">
<p><img alt="globinho111" height="64" id="globinho111" src="globinhoPe.png" style="display:none" width="64"/>
</p>
</div>
...
<p id="resp3"></p>
<div class="area">
<p><img alt="globinho13" height="64" id="globinho13" src="globinhoPe.png" style="display:none" width="64"/>
</p>
</div>
<hr/>
</div>
...
<div class="area">
<p><img alt="HemisferioIgual" class="w3-mobile" id="imagem8" src="tp3Foto6.jpg" style="display:block"/> </p>
</div>
<p>Locais em hemisférios opostos, somam-se as suas longitudes: </p>
<div class="area">
<p><img alt="HemisferioOposto" class="w3-mobile" id="imagem9" src="tp3Foto7.jpg" style="display:block"/> </p>
</div>
...
<div class="w3-margin"><input class="input" id="q1f" name="q1f" type="text" value=""/></div>
</form>
...
<p id="resp1f"></p>
<input class="btnShow" id="buttonConferirQ1f" onclick="PerguntasAbertas4(4,'resp1f','buttonConferirQ1f','globinho14')" type="button" value="Conferir"/>
<div class="area">
<p><img alt="globinho14" height="64" id="globinho14" src="globinhoPe.png" style="display:none" width="64"/>
</p>
</div>
...
<div class="w3-margin-top">
<button class="btn-acao-duvid" onclick="validarRadio(this, 'pergunta3', 'resp3', 'globinho3', 'Já está pegando o jeito!', '10')">
                    Confirmar Resposta
                </button>
</div>
...
<p>É possível voltar no tempo? O que a <mark>Linha Internacional de Mudança de Data</mark> tem a ver com
					isso?</p>
</div>
</div>
<button class="btnShow" onclick="MostrarProximo(this); this.style.display='none'">Proximo</button>
...
<p>É estranho pensar que haja um local em que o dia possa ter um início e um fim, uma vez que
		...
		<div class="area"><img alt="tp2Foto1" class="w3-mobile" id="imagem11" src="tp3Foto9.jpg" style="display:none"/>
</div>
...
<div class="area">
<p><img alt="globinho16" class="w3-mobile" id="globinho16" src="tp3Foto10.jpg" style="display:block"/>
</p>
</div>
...
<p class="w3-border w3-round-large"> <span class="primeiraLetra">P:</span> <strong>
                   ...
                   É verdade que se fizerem um buraco no
				chão vamos para na China?
                </strong> </p>
<p><span class="primeiraLetra">R:</span>

               Caso atravessemos o núcleo da Terra, quem sabe
			poderíamos chegar à China, ou em outro local diametralmente oposto. Eles locais são chamados de antípodas. E
			possuem uma diferença de 180º, isto é, cerca de 12h entre eles.

            </p>
<div class="area">
<p><img alt="foto11" class="w3-mobile" id="foto11" src="tp3Foto11.jpg" style="display:block"/> </p>
</div>
...
<p id="respFinal"></p>
<div class="area">
<p><img alt="globinhorespFinal" height="80" id="globinhorespFinal" src="/fotoIndex/globinhoPe.png" style="display:none" width="80"/>
</p>
</div>
<hr/>
</div>
...
<div class="bibliografias w3-content w3-padding-64" style="max-width:700px; display:none;">
<hr/>
<h3 class="w3-center w3-text-green fontePixel"><strong>Para saber mais:</strong></h3>
<div class="w3-row-padding">
<div class="w3-col m6 w3-margin-bottom">
<div class="postit-tp9 w3-red w3-card-4 pulsar">
<a href="https://blogdoaftm.com.br/china-fuso/" target="_blank">
<span class="w3-text-white">O mistério da China: Um país gigante com apenas um fuso horário</span>
</a>
</div>
</div>
<div class="w3-col m6 w3-margin-bottom">
<div class="postit-tp9 w3-blue w3-card-4 pulsar">
<a href="https://brasilescola.uol.com.br/geografia/linha-internacional-da-data.htm" target="_blank">
<span class="w3-text-white">Viagem no tempo? Entenda como funciona a Linha Internacional da Data</span>
</a>
</div>
</div>
<div class="w3-col m6 w3-margin-bottom">
<div class="postit-tp9 w3-amber w3-card-4 pulsar">
<a href="https://atlasescolar.ibge.gov.br/brasil/3025-federacao-e-territorio/3033-territorio.html" target="_blank">
<span class="w3-text-black">Mapa Oficial: Conheça os 4 fusos horários do Brasil (IBGE)</span>
</a>
</div>
</div>
<div class="w3-col m6 w3-margin-bottom">
<div class="postit-tp9 w3-deep-purple w3-card-4 pulsar">
<a href="https://brasilescola.uol.com.br/geografia/a-historia-meridiano-greenwich.htm" target="_blank">
<span class="w3-text-white">Observatório de Greenwich: Onde o tempo do mundo começa</span>
</a>
</div>
</div>
<div class="w3-container w3-padding-64">
<h3 class="fontePixel w3-center w3-text-green"><strong><i class="fa fa-book"></i> Referências
                        Bibliográficas</strong></h3>
<div class="w3-row-padding w3-margin-top">
<div class="w3-col l4 m6 w3-margin-bottom">
<div class="w3-card-4 w3-white w3-border-top w3-border-green" style="border-width: 6px !important; min-height: 180px;">
<div class="w3-container w3-padding">
<span class="w3-tag w3-green w3-small fontePixel">Livro Base</span>
<p class="w3-margin-top">CARVALHO, Edilson Alves de.<br/><b>Leituras cartográficas e
                                        interpretações estatísticasI</b><br/>2.ed. Natal: EDUFRN, 2011.</p>
</div>
</div>
</div>
<div class="w3-col l4 m6 w3-margin-bottom">
<div class="w3-card-4 w3-white w3-border-top w3-border-blue" style="border-width: 6px !important; min-height: 180px;">
<div class="w3-container w3-padding">
<span class="w3-tag w3-blue w3-small fontePixel">Cartografia</span>
<p class="w3-margin-top">PENA, Rodolfo F. Alves. <br/><b>Como calcular fuso horário?</b>.
                                    <br/>Disponível em:
...
<div class="w3-col l4 m6 w3-margin-bottom">
<div class="w3-card-4 w3-white w3-border-top w3-border-deep-orange" style="border-width: 6px !important; min-height: 180px;">
<div class="w3-container w3-padding">
<span class="w3-tag w3-deep-orange w3-small fontePixel">Narrativa</span>
<p class="w3-margin-top">VOGLER, Christopher. <br/><b>A jornada do escritor</b>. <br/>Rio
                                    de Janeiro: Nova Fronteira, 2006.</p>
</div>
</div>
</div>
<div class="w3-col l4 m6 w3-margin-bottom">
<div class="w3-card-4 w3-white w3-border-top w3-border-indigo" style="border-width: 6px !important; min-height: 180px;">
<div class="w3-container w3-padding">
<span class="w3-tag w3-indigo w3-small fontePixel">Documento Oficial</span>
<p class="w3-margin-top">BRASIL. Ministério da Educação. <br/><b>Base Nacional Comum
                                        Curricular</b>. <br/>Brasília: MEC/Secretaria de Educação Básica, 2018.</p>
</div>
</div>
</div>
</div>
