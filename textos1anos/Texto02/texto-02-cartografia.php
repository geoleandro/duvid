...
<div class="larguraBarTextos w3-padding-top-32">
	...
	<h1 id="h1"> Texto 02 – Cartografia: representações do espaço geográfico, localização e coordenadas geográficas.
	</h1>



	<p><strong>Conteúdo:</strong> Introdução à História da Cartografia; Mapas; Sistemas referenciais para
		localização espacial: pontos cardeais; Rotação; coordenadas geográficas, longitude, latitude. </p>




	<p><strong>Objetivo:</strong> Entender a importância da Cartografia para a construção do conhecimento do
		ser humano. Aplicar o sistema de coordenadas geográficas à localização de pontos na superfície terrestre. </p>
...
<div class="topico">
	...
	<button id="buttonConfira" class="btnShow" onclick="NomeAlunos('resp0','pq0')">Confirmar </button>

	<button id="buttonA" class="btnHide" onclick="MostrarProximo(this); this.style.display='none'">Proximo</button>
	<hr>
</div>
...
<div class="topico">
	...
	<p>Ao final, você saberá qual a importância da Cartografia para o conhecimento do ser humano e,
		também, aprenderá a localizar-se no espaço pelos pontos cardeais e pelas coordenadas geográficas. </p>
...
<div class="topico">
	...
	<p><strong>Duvid: </strong>Podemos imaginar. Antes o ser humano nem sabia escrever e já fazia pinturas nas
	...
	<p><strong>Cartografia: </strong>Foi minha primeira experiência, eu me lembro. Ah, como eu era
		...
		era bem nova, isso há uns 40 mil anos atrás na época do neolítico. Como o tempo passa, não é verdade?</p>

	<p><strong>Duvid: </strong>Sim, passa rápido. Aproveitando esse tema, nós pesquisamos sua rede social e
		descobrimos essa sua <span onclick="Aparecer('imagem1','citacao1')"><mark>obra aqui</mark></span> que a
		senhora postou
	...
	<p><strong>Cartografia: </strong>Vocês pesquisam mesmo sobre nossa origem! Esse trabalho é uma
		...
		escrever na argila, queríamos registrar o encontro do rio Tigre com o Eufrates, tempo bom aquele.</p>
	...
	<p><strong>Cartografia: </strong>Sem dúvida. Eu ajudei Eratóstenes, uns 200 anos antes de Cristo, a
		fazer um mapa da área até então conhecida pelos homens, eles não sabiam o que ainda estava por vir.</p>

	<p><strong>Duvid: </strong>Nós também recuperamos essa obra-prima. Olha, uma reconstituição (de autor
		não identificado) do <span onclick="Aparecer('imagem2','citacao2')"><mark>mapa de Eratóstenes</mark></span>,
		de cerca
	...
	<p><strong>Duvid: </strong>Esses gregos eram realmente incríveis. A china e o mundo árabe produziram
		muitos mapas. Mas na Idade Média, um chamou à atenção, <span onclick="Aparecer('imagem3','citacao3')"><mark>o mapa em
	...
	<span class="citacao" id="citacao3" style=display:none> Fonte: https://pt.wikipedia.org/wiki/Mapa_T_e_O. </span>
...
<div class="topico">
	...
	<div class="w3-padding">
		<h4 class="divCaixa1">Após ter lido a Entrevista com a Cartografia, <strong>escreva em seu caderno três
				perguntas</strong> que gostaria de fazer para aprender mais sobre esse tema. Seja criativo! Vale um
			globinho.
			Você precisará deles para completar sua aula e seguir adiante.</h4>
	</div>

	<button class="btnShow" onclick="MostrarProximo(this); MostrarFrase('resp9', 'globinho9a','','isso ai, ganhou seu primeiro globinho!','1'); this.style.display='none'">Proximo</button>
	...
	<div class="area">
		<p><img src="<?php echo URLSITE; ?>/images/ImagensCapa/globinhoPe.png" id="globinho9a" style="display:none" alt="globinho9a" width="64" height="64"> </p>
	</div>
...
<div class="topico">
	...
	<div class="w3-panel w3-leftbar w3-sand w3-margin w3-padding"> “Vai-se à escola para aprender a ler, a escrever
		e a
	...
	<p> As cartas, como veremos a seguir, representam áreas menores que o mapa. Esse registro do
		...
		montanhas, rios, árvores ou outros elementos da paisagem para retornarem de maneira segura para casa.:</p>
	<p> Outra referência principal foi por meio dos astros, no caso o Sol, a lua e as estrelas.
		Foi ai que foi desenvolvido pelos homens um sistema de referências chamado de <span onclick="this.innerHTML='pontos cardeais (pontos principais)'"><mark>pontos cardeais </mark></span>.
	...
	<p> É esse movimento que utilizamos para nos <span onclick="this.innerHTML='orientarmos (tomar o rumo certo)'"><mark> orientarmos </mark></span> no espaço.
		Desse modo, ao apontar o braço direito para onde o Sol nasce estabeleceu-se uma <span onclick="this.innerHTML='convenção (acordo)'"><mark> convenção </mark></span> que seria o ponto cardeal
	...
	<span class="citacao" id="citacao6" style=display:none> Constelação da Ursa menor. Fonte: Carpanelli (2015,
		p.7). Adaptado. </span>
	...
	<span class="citacao" id="citacao7" style=display:none> Constelação Cruzeiro do Sul. Fonte: Moreira e Sene
		(2016, p.32).
	...
	<p> É por isso que temos a <span onclick="Aparecer('imagem8','citacao8')"><mark>Rosa-dos-Ventos</mark></span>.
	...
	<p> Entretanto, essa navegação somente por orientação pelos astros, as vezes não é muito
		precisa ou exata. Diante disso, os aparelhos foram <span onclick="Aparecer('imagem9','citacao9')"><mark>aperfeiçoados
			</mark></span>, tais como a bússola, inventada pelos chineses e com uma agulha imantada que aponta para
...
<div class="topico">
	...
	<p>Denominação do local onde vemos o nascimento aparente do sol?</p>




	<button class="desativar3 p4  w3-padding area w3-margin " onclick=" MostrarProximo(this);RetirarPontos('resp3','globinho3', 'desativar3','');this.style.backgroundColor='tomato'">Oeste</button>
	<button class="desativar3 p4  w3-padding area w3-margin" onclick="MostrarProximo(this);MostrarFrase('resp3','globinho3', 'desativar3', 'muito bem, essa foi bem fácil ', '0.25'); this.style.backgroundColor='lightgreen'">
		Leste</button>
	<button class="desativar3 p4  w3-padding area w3-margin" onclick="MostrarProximo(this);RetirarPontos('resp3','globinho3', 'desativar3','');this.style.backgroundColor='tomato'">Sul</button>
	<button class="desativar3 p4  w3-padding area w3-margin" onclick="MostrarProximo(this);RetirarPontos('resp3','globinho3', 'desativar3','');this.style.backgroundColor='tomato'">Norte</button>
...
<div class="topico">
	...
	<p>Denominação do local onde vemos o poente do sol?</p>





	<button class="desativar4 p4 w3-padding area w3-margin" onclick="MostrarProximo(this);MostrarFrase('resp4','globinho4', 'desativar4', 'essa foi mamão com açúcar ', '0.25'); this.style.backgroundColor='lightgreen'">Oeste</button>


	<button class="desativar4 p4 w3-padding area w3-margin" onclick="MostrarProximo(this);RetirarPontos('resp4','globinho4', 'desativar4','');this.style.backgroundColor='tomato'">Norte</button>


	<button class="desativar4 p4 w3-padding area w3-margin" onclick="MostrarProximo(this);RetirarPontos('resp4','globinho4', 'desativar4','');this.style.backgroundColor='tomato'">Leste</button>


	<button class="desativar4 p4 w3-padding area w3-margin" onclick="MostrarProximo(this);RetirarPontos('resp4','globinho4', 'desativar4','');this.style.backgroundColor='tomato'">Sul</button>
...
<div class="topico">
	...
	<p>Denominação do local que fica a sua frente ao estender o braço esquerdo na direção do
		surgimento do sol?</p>




	<button class="desativar5 p4  w3-padding area w3-margin" onclick="MostrarProximo(this);RetirarPontos('resp5','globinho5', 'desativar5','');this.style.backgroundColor='tomato'">Norte</button>


	<button class="desativar5 p4  w3-padding area w3-margin" onclick="MostrarProximo(this);RetirarPontos('resp5','globinho5', 'desativar5','');this.style.backgroundColor='tomato'">Leste</button>


	<button class="desativar5 p4  w3-padding area w3-margin" onclick="MostrarProximo(this);RetirarPontos('resp5','globinho5', 'desativar5','');this.style.backgroundColor='tomato'">Oeste</button>


	<button class="desativar5 p4  w3-padding area w3-margin" onclick="MostrarProximo(this);MostrarFrase('resp5','globinho5', 'desativar5', 'suave na nave essa questão', '0.25'); this.style.backgroundColor='lightgreen'">Sul</button>
...
<div class="topico">
	...
	<p>Denominação do local que fica em suas costas ao estender o braço direito na direção poente
		do sol?</p>
	...
	<button class="desativar6 p4  w3-padding area w3-margin " onclick="MostrarProximo(this);RetirarPontos('resp6','globinho6', 'desativar6','');this.style.backgroundColor='tomato'">Sul</button>

	<button class="desativar6 p4  w3-padding area w3-margin" onclick="MostrarProximo(this);MostrarFrase('resp6','globinho6', 'desativar6', 'essa foi de boa na lagoa ', ' 0.25'); this.style.backgroundColor='lightgreen'">Norte</button>


	<button class="desativar6 p4  w3-padding area w3-margin" onclick="MostrarProximo(this);RetirarPontos('resp6','globinho6', 'desativar6','');this.style.backgroundColor='tomato'">Leste</button>


	<button class="desativar6 p4  w3-padding area w3-margin" onclick="MostrarProximo(this);RetirarPontos('resp6','globinho6', 'desativar6','');this.style.backgroundColor='tomato'">Rotação</button>
...
<div class="topico">
	...
	<button class="btnShow" onclick="MostrarProximo(this); VerificaInteiro('resp6');this.style.display='none'">Proximo</button>
	<hr>
...
<div class="topico">
	...
	<p class="paragrafo  caixa"> Teste suas habilidades!</p>



	<div class="w3-container">
		<h4 class="divCaixa1"> Encontre as direções dos objetos no mapa do tesouro abaixo e as escreva
			corretamente:</h4>
		<p><img src="tp2Foto10.png" alt="teste2" class="w3-mobile"> </p>
	</div>
	...
	<form id="quiz" name="quiz">
		...
		<p>Em qual direção está o coqueiro ?</p>
		<div class="area"><input class="input" id="q1a" type="text" name="q1a" value=""></div>
		...
		<div class="w3-padding-24">
			<input class="btnShow" id="buttonConferirQ1" type="button" value="Conferir" onclick="PerguntasAbertas(1,'resp1a','buttonConferirQ1','globinho8')">
		</div>
		...
		<div class="area">
			<p><img src="<?php echo URLSITE; ?>/images/ImagensCapa/globinhoPe.png" id="globinho8" style="display:none" alt="globinho8" width="64" height="64"> </p>
		</div>
		...
		<p>Em qual direção está o baú do tesouro ?</p>

		<div class="area"><input class="input" id="q1c" type="text" name="q1c" value=""></div>
		...
		<div class="w3-padding-24">
			<input class="btnShow" id="buttonConferirQ1c" type="button" value="Conferir" onclick="PerguntasAbertas(3,'resp1c','buttonConferirQ1c','globinho10')">
		</div>



		<div class="area">
			<p><img src="<?php echo URLSITE; ?>/images/ImagensCapa/globinhoPe.png" id="globinho10" style="display:none" alt="globinho10" width="64" height="64"> </p>
		</div>
...
<div class="topico">
	...
	<div class="w3-panel w3-leftbar w3-sand w3-margin">
		...
		<p class="w3-sand"> É preciso lembrar que ninguém escolhe o ventre, a localização
			geográfica, a
	...
	<p>Pode-se <span onclick="this.innerHTML='inferir (concluir, deduzir)'"><mark> inferir
			</mark></span> do texto acima:</p>

	<button class="desativar7 p4 area w3-margin" onclick="MostrarProximo(this);RetirarPontos('resp7','globinho7', 'desativar7','1');this.style.backgroundColor='tomato'">a)
		a política territorial é seletiva.</button>


	<button class="desativar7 p4 area w3-margin" onclick="MostrarProximo(this);MostrarFrase('resp7','globinho7', 'desativar7', 'essa foi uma boa questão, acertou! ', ' 1'); this.style.backgroundColor='lightgreen'">b)
		a política deve abranger a todos.</button>


	<button class="desativar7 p4 area w3-margin" onclick="MostrarProximo(this);RetirarPontos('resp7','globinho7', 'desativar7','1');this.style.backgroundColor='tomato'">c)
		a vida é feita de escolhas. </button>
	...
	<div class="area">
		<p><img src="<?php echo URLSITE; ?>/images/ImagensCapa/globinhoPe.png" id="globinho7" style="display:none" alt="globinho7" width="64" height="64"> </p>
	</div>
...
<div class="topico">
	...
	<button class="btnShow" onclick="MostrarProximo(this); MostrarFrase('resp1', 'globinho1','','Esse exercício merece mais um globinho',' 1'); this.style.display='none'">Proximo</button>
	...
	<div class="area">
		<p><img src="<?php echo URLSITE; ?>/images/ImagensCapa/globinhoPe.png" id="globinho1" style="display:none" alt="globinho1" width="64" height="64"> </p>
	</div>
...
<div class="topico">
	...
	<p class="paragrafo borda"> <span class="primeiraLetra">P:</span> <strong>Sempre que penso em Geografia já
			me
			lembro de mapas, isso é correto?</strong> </p>
	...
	<p><span class="primeiraLetra">R:</span> Para saber quanto vale 1º grau devemos dividir a
		...
		em
		apenas 01 hora. Calcular a longitude é fazer esse cálculo de tempo entre uma posição e outra. </p>
...
<div class="topico">
	...
	<p class="paragrafo  caixa"> Combine as imagens com textos sobre o tema da Cartografia. Valor: 3 globinhos.
	</p>
	<br><br>
	...
	<div class="area">
		<div class="grid-container">
			<div id="div9">Mapa</div>
			<div><img id="div12" src="tp2Foto14.png" alt="div12" width="100" height="80"></div>
			<div id="div7">Cruzeiro do Sul</div>
			<div id="div8"><img id="div8a" src="tp2Foto5.png" alt="div8" width="100" height="60"></div>
			<div><img id="div2" src="tp2Foto12.png" alt="div2" width="100" height="80"></div>
			<div><img id="div4" src="tp2Foto10.png" alt="div4" width="100" height="80"> </div>
			<div id="div1">Rotação </div>
			<div id="div11">Longitude</div>
			<div><img id="div10" src="tp2Foto17.png" alt="div10" width="100" height="60"> </div>
			<div><img id="div6" src="tp2Foto7.png" alt="div6" width="100" height="120"></div>
			<div id="div3">Latitude</div>
			<div id="div5">Bússola</div>
...
<div class="topico">
	...
	<button class="btnShow" onclick="mostraCinza2(); this.style='display:none'">Finalizar</button>
...
<div class="bibliografias">
	...
	<p>CARPANELLI,Francesca. <strong>La geografia in 30 lezioni</strong>. Geografia generale ed economica.
		Itália:
		Zanichelli, 2015.</p>

	<p>FREITAS, Maria Isabel Castreghini de (Org.). <strong>Cartograﬁa e Meio Ambiente</strong>. Rio Claro:
		IGCE/UNESP; Bauru: FC/Unesp; CECEMCA. 2005.</p>

	<p>SENE, Eustáquio de; MOREIRA, João Carlos. <strong>Geografia geral e do Brasil</strong>: espaço geográfico
		e
		globalização: ensino médio 3. ed. São Paulo: Scipione, 2016.</p>

	<p>Yves Lacoste. <strong>A geografia</strong> – isso serve, em primeiro lugar, para fazer a guerra. 2. ed.
...
<script>
	...
	function PerguntasAbertas(qnum, idResp, buttonConferir, globinho) {
		...
		var imagem = ['../../../fotoIndex/globinhoPe.png'];
		...
		if (q1a.match("noroeste") && qnum == 1) {
			...
			Play("../audio1.mp3");
			document.getElementById(idResp).innerHTML = "Sua resposta foi: " + q1a.valueOf() + ".";
			nota += 0.5;
	...
	//Função para esconder imagens no Desafio

	// Adcionei um evento clique no botão e criei uma variavel global Clicou1 ou Clicou2


	var foto1 = document.getElementById("div1").addEventListener("click", function() {
		Clicou1 = 1;
		ComparaImagens("resp10");
	});


	var foto2 = document.getElementById("div2").addEventListener("click", function() {
		Clicou2 = 2;
		ComparaImagens("resp10");
	});


	var foto3 = document.getElementById("div3").addEventListener("click", function() {
		Clicou1 = 2;
		ComparaImagens("resp10");
	});

	var foto4 = document.getElementById("div4").addEventListener("click", function() {
		Clicou1 = 3;
		ComparaImagens("resp10");
	});

	var foto5 = document.getElementById("div5").addEventListener("click", function() {
		Clicou1 = 4;
		ComparaImagens("resp10");
	});

	var foto6 = document.getElementById("div6").addEventListener("click", function() {
		Clicou1 = 5;
		ComparaImagens("resp10");
	});

	var foto7 = document.getElementById("div7").addEventListener("click", function() {
		Clicou2 = 5;
		ComparaImagens("resp10");
	});

	var foto8 = document.getElementById("div8").addEventListener("click", function() {
		Clicou2 = 1;
		ComparaImagens("resp10");
	});

	var foto9 = document.getElementById("div9").addEventListener("click", function() {
		Clicou2 = 3;
		ComparaImagens("resp10");
	});

	var foto10 = document.getElementById("div10").addEventListener("click", function() {
		Clicou2 = 4;
		ComparaImagens("resp10");
	});

	var foto11 = document.getElementById("div11").addEventListener("click", function() {
		Clicou1 = 6;
		ComparaImagens("resp10");
	});

	var foto12 = document.getElementById("div12").addEventListener("click", function() {
		Clicou2 = 6;
		ComparaImagens("resp10");
	});
	...
	// Função do desafio final
	function ComparaImagens(idResp) {


		let cor = ["#99ff99", " #ee4466"];

		if (Clicou1 == 1 && Clicou2 == 1) {

			document.getElementById("div1").style.opacity = "30%";

			document.getElementById("div8").style.opacity = "30%";
			Play("../audio1.mp3");

			notaDesafio++;

		} else if (Clicou1 == 2 && Clicou2 == 2) {

			document.getElementById("div2").style.opacity = "30%";
			document.getElementById("div3").style.opacity = "30%";
			notaDesafio++;
			Play("../audio1.mp3");


		} else if (Clicou1 == 3 && Clicou2 == 3) {

			document.getElementById("div4").style.opacity = "30%";
			document.getElementById("div9").style.opacity = "30%";
			notaDesafio++;
			Play("../audio1.mp3");

		} else if (Clicou1 == 4 && Clicou2 == 4) {

			document.getElementById("div10").style.opacity = "30%";
			document.getElementById("div5").style.opacity = "30%";
			notaDesafio++;
			Play("../audio1.mp3");

		} else if (Clicou1 == 5 && Clicou2 == 5) {

			document.getElementById("div6").style.opacity = "30%";
			document.getElementById("div7").style.opacity = "30%";
			notaDesafio++;
			Play("../audio1.mp3");

		} else if (Clicou1 == 6 && Clicou2 == 6) {

			document.getElementById("div11").style.opacity = "30%";
			document.getElementById("div12").style.opacity = "30%";
	...
	// Função que adiciona fundo verde no desafio, foi inserida na função nota final
	function ClassGrid() {


		var g = document.getElementsByClassName("grid-container");
		for (var i = 0; i < g.length; i++) {
			if (notaDesafio >= 6) {
				g[i].style.backgroundColor = "green";
				nota += 3;
